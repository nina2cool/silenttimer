...
<? if($TheTest != ""){echo $TheTest;}else{echo "The";}?> The Silent Timer&#8482; Features
<font size="3">(in detail)</font></strong></font></p>
<table width="100%"  border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000066" face="Times New Roman, Times, serif"><a name="2004"></a><a href="http://www.silenttimer.com">THE
              SILENT TIMER</a></font>&#8482;</strong> is designed to help you
              time your
...
find more pictures and details.</font></td>
    <td bgcolor="#FFFF99"><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"><strong><span class="big"><a href="<? echo $https;?>product.php<? if($TheTest != ""){echo "index.php?t=$TheTest";}?>">Click
                here to buy your
                <? if($TheTest != ""){echo $TheTest;}?>
  timer </a></span>! </strong></font></div></td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td rowspan="2"><p><font size="2" face="Arial, Helvetica, sans-serif">There are many
          testing features for </font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000066" face="Times New Roman, Times, serif"><a href="http://www.silenttimer.com">THE
          SILENT TIMER</a></font>&#8482;</strong></font><font size="2" face="Arial, Helvetica, sans-serif">.
          Explore our features in detail below:</font></p>
      <blockquote>
        ...
        <blockquote>
          <p><font size="2" face="Arial, Helvetica, sans-serif"> <a href="#a">-
                Total Time<br>
    ...
    <td><div align="center"><img src="pics/timerDetails.jpg" alt="The Silent Timer, test, SAT, LSAT, MCAT, GMAT, GRE, SAT, ACT.  Time your test." width="339" height="286" border="0" usemap="#Map">
          <map name="Map">
            <area shape="rect" coords="10,6,118,27" href="#5">
            <area shape="rect" coords="46,53,59,79" href="#5">
            <area shape="rect" coords="63,62,127,95" href="#2">
            <area shape="rect" coords="134,12,213,61" href="#4">
            <area shape="rect" coords="230,9,317,24" href="#3">
            <area shape="rect" coords="137,72,293,151" href="#3">
            <area shape="rect" coords="58,96,128,134" href="#6">
            <area shape="poly" coords="59,137,59,214,161,215,161,156,91,156,91,137" href="#8">
            <area shape="rect" coords="75,258,148,273" href="#8">
            <area shape="rect" coords="187,157,292,216" href="#7">
            <area shape="rect" coords="196,257,288,273" href="#7">
          </map>
    </div></td>
  </tr>
  <tr>
    <td><div align="center"><img src="pics/timer_side_measure.jpg" alt="The Silent Timer fits on your desk." width="300" height="222"></div></td>
  </tr>
</table>
<br>
<table width="100%" border="0" cellspacing="0" cellpadding="8">
  <tr> 
    <td width="97%" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="1"></a></font><font color="#000000" face="Times New Roman, Times, serif">THE
            SILENT TIMER</font><font color="#000000">&#8482; is Designed for
      Tests</font></font></strong></td>
    <td width="3%" align="center" valign="top" bgcolor="#003399"> <div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">&lt;</font></strong></div></td>
  </tr>
  <tr align="left" valign="top"> 
    <td colspan="2"> <p align="left"><font size="2" face="Arial, Helvetica, sans-serif">For 
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><em>Note:</em></strong> If
          your testing center does not allow timers with a keypad or multifunctional
          timers, <a href="http://www.silenttimer.com/testhome/lsat_test.php" target="_blank"><strong><font color="#0000FF">The
          Silent Timer&#8482; LSAT
          Bonus Combo</font></strong></a> contains
          a free simplified bonus timer (silent, count up/down, large LCD screen)
          for use on test day along with </font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000066" face="Times New Roman, Times, serif">THE
          SILENT TIMER</font>&#8482;.</strong></font><font size="2" face="Arial, Helvetica, sans-serif"> <a href="http://www.silenttimer.com/testhome/lsat_test.php" target="_blank">Learn
      more here.</a></font></p>
  ...
  <tr> 
    <td bgcolor="#FFFFCC"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="2" id="2"></a></font><font color="#000000">Silence
      is Golden</font></strong></font></td>
  ...
  <tr valign="top"> 
    <td colspan="2" align="left"> <p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000066" face="Times New Roman, Times, serif"><a href="http://www.silenttimer.com">THE
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif">Not all testing centers
          allow desktop timers into the exam room. Know the rules of your test
          before test day to avoid surprises.</font></p>
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><em>*Note:</em></strong> If
          your testing center does not allow timers with a keypad or multifunctional
          timers, <a href="http://www.silenttimer.com/testhome/lsat_test.php" target="_blank"><strong><font color="#0000FF">The
          Silent Timer&#8482; LSAT Bonus Combo</font></strong></a> contains a
  ...
  <tr> 
    <td bgcolor="#FFFFCC"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="3" id="3"></a></font><font color="#000000">The 
    ...
    <td colspan="2" align="left"> <p align="left"><font size="2" face="Arial, Helvetica, sans-serif">Your 
      ...
      <blockquote> 
        ...
        <p align="left"><font size="2" face="Arial, Helvetica, sans-serif">The 
          ...
          between count down and count up during a test simply by pressing &quot;<a href="#j">SET</a>&quot;. 
  ...
  <tr> 
    <td bgcolor="#FFFFCC"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="4" id="4"></a></font><font color="#000000">The
      Red, Answer Button</font></strong></font></td>
    <td align="center" valign="top" bgcolor="#003399"> <div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">&lt;</font></strong></div></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td bgcolor="#FFFFCC"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="5" id="5"></a></font><font color="#000000">Red, 
  ...
  <tr bgcolor="#FFFFCC"> 
    <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="6" id="6"></a></font><font color="#000000">Test 
    ...
    <td colspan="2"> 
      ...
      <table width="325" border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          ...
          <td><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">Stored
                  Times </font></strong></div></td>
        </tr>
        <tr>
          <td width="43"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a name="p"></a><a href="../handbook/standardizedtest/lsat/index.php">LSAT</a></strong></font></div></td>
          <td width="241"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">35m,
          30m </font></div></td>
        </tr>
        <tr>
          <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a name="q"></a><a href="../handbook/standardizedtest/mcat/index.php">MCAT</a></strong></font></div></td>
          <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">1h 40m, 1hr
              25min, 30m </font></div></td>
        </tr>
        <tr>
          <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a name="r"></a><a href="../handbook/standardizedtest/sat/index.php">SAT</a></strong></font></div></td>
          <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">20m,
                25m, 35m</font></div></td>
        </tr>
        <tr>
          <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a name="s"></a><a href="../handbook/standardizedtest/act/index.php">ACT</a></strong></font></div></td>
          <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">35m, 45m, 1h </font></div></td>
        </tr>
      </table>
  ...
  <tr bgcolor="#FFFFCC"> 
    <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="7"></a></font><font color="#000000">Control 
  ...
  <tr align="left" valign="top"> 
    <td colspan="2"> <p align="left"><font size="2" face="Arial, Helvetica, sans-serif">These 
      ...
      <p align="center"><font size="2" face="Arial, Helvetica, sans-serif"><img src="pics/buttons-right.jpg" alt="With The Silent Timer, you can easily control your test taking time." width="250" height="188" border="0" usemap="#Map4Map"></font><font size="2" face="Arial, Helvetica, sans-serif">
        <map name="Map4Map">
          <area shape="rect" coords="152,104,194,129" href="#o">
          <area shape="rect" coords="108,105,148,130" href="#n">
          <area shape="rect" coords="61,105,105,131" href="#k">
          <area shape="rect" coords="153,78,193,103" href="#m">
          <area shape="rect" coords="108,78,149,104" href="#l">
          <area shape="rect" coords="61,79,104,103" href="#k">
          <area shape="rect" coords="151,48,193,77" href="#j">
          <area shape="rect" coords="109,47,150,77" href="#i">
          <area shape="rect" coords="62,49,107,76" href="#h">
        </map>
      </font></p>
  ...
  <tr bgcolor="#FFFFCC"> 
    <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><a name="8" id="8"></a></font><font color="#000000">Keypad 
