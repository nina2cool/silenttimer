 ...
 # loop out all shopping cart items
			for($i=0; $i < count($ShoppingCart); $i++)
			{
				...
				{				
					...
					<br>
         			<a href="test_shoppingcart.php?remove=y&cart=<? echo $i;?>"><img src="images/cartremove.jpg" width="85" height="25" border="0"></a> 
        			  </font>
					</form>
					
					</td>
					<td ><p><b><? echo $ProductName; ?></b><br>					  </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
  <tr>
    <td width="51%" height="36"><a href="<? echo $https;?>test_product.php"><font size="3" face="Arial, Helvetica, sans-serif">&lt; Continue Shopping</font></a></td>
    <td width="49%"><div align="right">

<?		
		if($NotEmpty=="y" ){?>
       <a href="<? echo $https;?>order/test_order1.php?"><font size="3" face="Arial, Helvetica, sans-serif">Check Out &gt;</font></a>
