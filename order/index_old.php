...
<div align="right"> <font size="2" face="Arial, Helvetica, sans-serif"><strong>Purchase 
  your 
  <? if($tURL != ""){echo $tURL;}?>
  Test Timer below<font color="#FFFFFF">..</font></strong></font></div>
<table width="100%" border="0" cellspacing="0" cellpadding="6">
  <tr align="left" valign="top"> 
    <td width="623"> <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000099">
        <tr>
          <td><table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr> 
                <td width="77%" valign="top"><font size="5" face="Arial, Helvetica, sans-serif"><strong>Timer 
                  Order Form</strong></font> <br> <font size="2" face="Arial, Helvetica, sans-serif">Enter 
                  your order information below.</font></td>
                <td width="23%" align="left" valign="top"><div align="center"><img src="pics/Front-Logo-blue.jpg" alt="The Silent Timer Order Page - LSAT, MCAT, SAT, ACT, GMAT, GRE,  PSAT, SAT II, BAR, CPE, etc."></div></td>
              </tr>
            </table></td>
        </tr>
      </table>
      <? if($PromoNote != ""){ ?>
      <table width="80%" border="1" cellpadding="1" cellspacing="0" bordercolor="#FF0000">
        <tr> 
          <td align="left" valign="top"> <p><font color="#CC0000" size="2" face="Arial, Helvetica, sans-serif"><strong>Special 
              Promotion</strong></font><br>
            </p>
      ...
      <? }?>
      <br>
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><em>FREE Shipping!</em></strong> 
        Get your timer in time for your <? echo $TextTest;?>.</font> <font size="2" face="Arial, Helvetica, sans-serif"><strong>We 
        now ship worldwide!</strong></font> </p>
      ...
      <p align="left"><font size="2" face="Arial, Helvetica, sans-serif">If you 
        have any timer questions, please <a href="<? echo $http; ?>contactus.php">contact 
        us</a>.<br>
        </font></p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="40%" height="18">
<div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>legal/guarantee.php"><img src="pics/Money-Back-Guarantee.jpg" alt="The Silent Timer 100% Quality Guarantee.  You like your timer, or your money back!" width="87" height="86" border="0"></a> 
              </font></div></td>
          <td width="60%">
<div align="center"><a href="" onclick="Rcertify();return false;"><img src="../pics/ReliabilitySeal3.gif" alt="BBBOnLine Reliability Seal" BORDER=0></a></div></td>
    ...
    <td width="259"><div align="right"> 
        <table width="259" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
          <tr> 
            <td align="left" valign="top" bgcolor="#FFFFFF"> <table width="0%" border="0" cellpadding="4" cellspacing="0" bordercolor="#000033">
                <tr> 
                  <td bgcolor="#FFFFFF"> <div align="center"><a href="<? echo $http; ?>gallery/index.php"><img src="../timer/pics/home/<? echo rand(2,34);?>.jpg" alt="The only timer made for your <? echo $TextTest;?>.  Quiet, Silent, Digital Timer! LSAT, MCAT, GMAT, GRE, CPE, SAT, ACT, etc!" width="243" height="182" border="0"></a></div></td>
                </tr>
                <tr> 
        ...
        <? }else{?>
        <p align="center"><font size="6" face="Arial, Helvetica, sans-serif"><strong>$<em><? echo number_format($price,2);?></em></strong></font></p>
        <? }?>
        <div align="center"><strong><font color="#000099" size="5"><em><font color="#CC0000" face="Arial, Helvetica, sans-serif">FREE 
...
<form action="confirm.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmOrder" id="frmOrder" onSubmit="return CheckOrder();">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000099">
    <tr> 
      <td align="left" valign="top"> <p><strong><font color="#000099" size="3" face="Arial, Helvetica, sans-serif">&nbsp;&gt; 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="8">
          ...
          <tr align="left" valign="top"> 
            <td width="55%"><p><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">Shipping 
                ...
                <select name="cboShippingOption" id="cboShippingOption">
                  <?    
					...
					$sql = "SELECT tblShippingOption.ShippingOptionID, Name, CompanyName, tblShippingCost.Cost
							...
							WHERE  tblShippingOption.ShipperID = '8' AND tblShippingCost.Number = '1' AND tblShippingOption.Status = 'active'";
                ...
                </strong><font color="#999999">(Only for USA orders. International 
                shipping is below)</font><strong><br>
                </strong></font><font size="2" face="Arial, Helvetica, sans-serif"><font size="1" face="Arial, Helvetica, sans-serif">**
                Express shipping is overnight to most areas.<br>
                * 
                Orders are processed and shipped within 2 business days. Shipping
                does not occur on Saturdays or major holidays.</font></font></font></p>
              <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><em><font color="#CC0000">Test 
                coming up fast?</font> Order today &amp; get your timer tomorrow!</em></strong> 
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000099">
    <tr>
      <td align="left" valign="top"> 
        <p><strong><font color="#003399" size="3" face="Arial, Helvetica, sans-serif">&nbsp;<font color="#000099">&gt; 
          Shipping Information</font></font></strong></p>
        <table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr align="left" valign="top"> 
          ...
          <tr align="left" valign="top"> 
            <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">Address 
              ...
              <font size="2" face="Arial, Helvetica, sans-serif"><font color="#999999"><strong><font color="#666666">Max
               30 characters</font></strong></font></font></font></td>
          </tr>
          <tr align="left" valign="top"> 
            <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">Address 
              ...
              <font size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif"><font color="#999999"><strong><font color="#666666">Max
               30 characters</font></strong></font></font></font></font></td>
          </tr>
          <tr align="left" valign="top"> 
                ...
                <tr> 
                    ...
                    * <br>
                    ...
                    <select name="txtCountry" class="text" id="txtCountry" onChange="visible_shipping('foreign_shipping');">
                      ...
                      <?  
						...
						{
					?>
                      <option value="<? echo $row[ISO];?>" <? if($row[ISO] == $Country){echo "selected";}else{if($_POST['goback'] != "yes") {if($row[ISO] == "US"){echo "selected";}}}?>><? echo $row[Name]; if($row[USPS_Cost] > 0){echo " +$".number_format($row[USPS_Cost])." USPS";}?></option>
                      <?
						}
					?>
                    </select>
                    <font color="#999999">(Don't see your country?  <a href="mailto:info@silenttimer.com">Email
                    us</a> to order!)</font></font></td>
                  <td width="53%" align="left" valign="top"> 
					  <div style="<? if($_POST['goback'] == "yes") { if($Country != "US"){echo "display:";}else{echo "display:none";} }else{echo "display:none";}?>" id = "foreign_shipping"> 
                        ...
                        </strong> <font color="#000000">USPS (4-8 days)</font></font></div>
					  </div>
				  </td>
                </tr>
              </table></td>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000099">
    <tr>
      <td align="left" valign="top"> 
        <p><font color="#003399" size="3" face="Arial, Helvetica, sans-serif"><strong>&nbsp;<font color="#000099">&gt; 
          Billing Information</font></strong></font></p>
