...
<form action="test_order3.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmBack" id="frmBack">
  <div align="left">
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" bordercolor="#003399">
 ...
 # loop out all shopping cart items
        ...
        <tr>
		  ...
		  <form action="test_order2.php" method="post" name="frmUpdate" id="frmUpdate">
		...
		<form action="test_order2.php" method="post" name="frmRemove" id="frmRemove">
...
<form action="test_receipt2.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmOrder" id="frmOrder" onSubmit="return lockButton(document.frmOrder.Confirm.value);">
