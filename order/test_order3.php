...
<form action="test_order2.php" method="post" name="frmBack" id="frmBack">
...
<form action="test_order4.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmOrder" id="frmOrder" onSubmit="return CheckOrder();">
