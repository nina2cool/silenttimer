...
# ------------------------------------------------------------------------------------------------------------
	...
	if($_POST['PickUp'] == "I Will Pick One Up")
	{
		...
		$mail->AddBCC("erik@silenttimer.com", "Silent Timer Retail");
...
<form action="index.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmBack2" id="frmBack2">
  <div align="left"> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="44%" align="left" valign="top"> <form action="receipt.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmOrder" id="frmOrder" onSubmit="return lockButton(document.frmOrder.Confirm.value);">
        <div align="left"> 
    ...
    <td width="56%" align="right" valign="top"> <form action="index.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmBack" id="frmBack">
        <div align="right"> 
