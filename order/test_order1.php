...
<p><font size="2" face="Arial, Helvetica, sans-serif"><strong>Please enter
        ...
        field.</strong></font></p>
<form action="test_order2.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmOrder" id="frmOrder" onSubmit="return CheckOrder();">
            ...
            <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td align="left" valign="top"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>Country 
                    ...
                    <font color="#999999">(Residents of AK, HI, and PR, select &quot;United
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="8">
            ...
            <tr align="left" valign="top">
              <td colspan="2"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>Country 
                ...
                <font color="#999999">(Residents of AK, HI, and               PR,
                select &quot;United States Offshore&quot;.)</font> <strong><a href="qc.php" target="_blank"><img src="../images/quest.jpg" alt="Help with countries" width="17" height="14" border="0"></a></strong></font></td>
            </tr>
          </table>
