...
if ($auth=="Y")
{
	...
	#-------------------------------------------	
		...
		$althtml .="
		You will receive your tracking number in an email soon.";
...
<p><font size="2" face="Arial, Helvetica, sans-serif">Thank you for your 
  order! Print this receipt for your records. You may use your order number to 
  track your shipment, so hold onto it!</font></p>
...
<table width="48%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#FF0000">
  <tr>
    <td><p><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><strong>NOTE TO PRINCETON
          REVIEW STUDENTS:</strong></font></p>
    <p><font size="2" face="Arial, Helvetica, sans-serif">If you elected the
        &quot;<strong>PICK UP</strong>&quot; option, your instructor will be
        picking up your order and delivering it to you in class. You do not need
        to come by the Silent Timer office to claim your order.</font></p>
    <p><font size="2" face="Arial, Helvetica, sans-serif">Contact your instructor
        for more information. </font></p></td>
  </tr>
</table>
<? } ?>
...
<p><font size="2" face="Arial, Helvetica, sans-serif">You will receive
       ...
       *
       <em><font color="#666666">Please be
       aware  your e-mail provider may filter your confirmation email as spam.
Add &quot;info@silenttimer.com&quot; to your Safe Email list.*</font></em></font></p>
<p><font size='2' face='Arial, Helvetica, sans-serif'>You can also log in to
    our web site and check the status of your order, view your order history,
    get downloads, and more. Go to <a href='http://www.silenttimer.com/customerservice/'>http://www.silenttimer.com/customerservice/</a> and
fill in your information.</font></p>
<p><font size="2" face="Arial, Helvetica, sans-serif"><em>EARN <strong><font color="#00CC33">$5</font></strong> FOR
    EVERY FRIEND WHO PURCHASES THE SILENT TIMER. <a href="http://www.silenttimer.com/customerservice/">Log
    in to your account</a> to refer your friends and make money. </em></font></p>
<p><font size="2" face="Arial, Helvetica, sans-serif">Don't forget to
      download your time management guide:</font></p>
