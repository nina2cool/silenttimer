...
<br>
<table width="300" border="1" cellpadding="5" cellspacing="0" bordercolor="#CC0000" bgcolor="#DDFFDD">
  <tr>
    <td><div align="center"><strong><font size="3" face="Arial, Helvetica, sans-serif"><a href="../holiday.php"> Holiday Shipping Schedule</a><br>
      </font></strong><font size="3" face="Arial, Helvetica, sans-serif">      <font size="2"><a href="../holiday.php">click here</a></font> </font></div></td>
  </tr>
</table>
                ...
                <select name="cboShippingOption" id="cboShippingOption">
                  <?    
					...
					$sql = "SELECT tblShippingOption.ShippingOptionID, Name, CompanyName, tblShippingCost.Cost
							...
							WHERE  tblShippingOption.ShipperID = '6' AND tblShippingCost.Number = '1' AND tblShippingOption.Status = 'active'";
