...
if ($auth=="Y")
{
			...
			*/
			...
			$sql88 = "SELECT * FROM tblPromotionCode WHERE PromotionCodeID = '$cID' AND PromotionID = 'percent'";
			//echo $sql88;
			$result88 = mysql_query($sql88) or die("Cannot count promo codes");
			
			$PromoCount = mysql_num_rows($result88);
			...
			{
			$sql888 = "UPDATE tblPromotionCode SET EndDate = '$PromoEndDate' WHERE PromotionCodeID = '$cID' AND PromotionID = 'percent'";
			//echo $sql888;
			$result888 = mysql_query($sql888) or die("Cannot update tblPromotionCode");
			}
	...
	#-------------------------------------------	
		...
		//////////////////////
			...
			//$mail->AddBCC("siobhan@silenttimer.com", "Silent Timer Orders");
		...
		<body>
		  ...
		  <tr>
			<td class='main'><p><font color='#003399' size='2' face='Arial, Helvetica, sans-serif'><strong>Your 
			  ...
			  <p><font size='2' face='Arial, Helvetica, sans-serif'><a href='http://www.silenttimer.com/order/guide/ST_TimeManGuide_080807.pdf' target='_blank'>Click
			        here</a> to
			      download<em> &quot;The
		...
		Go here if you did not download the Silent Timer Time Management Guide on the receipt page: http://www.silenttimer.com/order/guide/ST_TimeManGuide_080807.pdf. It is in PDF format, and gives you some valuable pointers for how to use your timer during practice and on test day.
		...
		//$mail->AddAddress("siobhan@silenttimer.com", "Siobhan Dilly");
      ...
      <table width="48%" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000">
        <tr>
          <td><p><font color="#FF3300" size="2" face="Arial, Helvetica, sans-serif"><strong>The
              ...
              Name:</strong> <em>ST_TimeManGuide</em>_080807.pdf<br>
                    <strong>File Size:</strong> 288 KB</font><strong><font size="2" face="Arial, Helvetica, sans-serif"><br>
                    <a href="guide/ST_TimeManGuide_080807.pdf" target="_blank">Click
