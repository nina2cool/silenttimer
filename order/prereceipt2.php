...
# link to Database...
	...
	if ($_POST['ConfirmButton'] == "Pressed")
	{
		...
		$OriginalProductTotal = $_POST['OriginalProductTotal'];
		...
		if($isCheck != "y")
		{
			...
			if ($Same == "y")
			{
				...
				&Total=$ProductTotal&Address=$Address&Zip=$ZipCode
				&CVV2Type=1&CVV2=$CVV2&HTML=No";
			}
			else
			{
				$data = "ePNAccount=040358&CardNo=$CreditCardNo&ExpMonth=$ExpMonth&ExpYear=$ExpYear
				&Total=$ProductTotal&Address=$AddressB&Zip=$ZipCodeB
				&CVV2Type=1&CVV2=$CVV2&HTML=No";
			}
		...
		else 
		{
			...
			if ($Same == "y")
			{
				...
				&Total=$ProductTotal&Address=$Address&City=$City&State=$State&Zip=$ZipCode&Phone=$Phone&HTML=No";
			}
			else
			{
				...
				&Total=$ProductTotal&Address=$AddressB&City=$CityB&State=$StateB&Zip=$ZipCodeB&Phone=$Phone&HTML=No";
			}
...
if ($auth=="Y")
{
			...
			OtherStateB, CountryIDB, ZipB, Paid, Preorder, Status, Preordered)
			VALUES ($cID, '$Test', '$TestDate', '$ReferredByID', '$TaxTotal', '$OriginalProductTotal', '$Discount', '$now', '$ShipCostID', $ShipCost, 
			'$PromotionID', '$ip', '$Same', '$FirstNameB', '$LastNameB', '$AddressB', '$CityB', '$StateB',  '$State_OtherB',
			'$CountryB', '$ZipCodeB', 'y', 'y', 'active', 'y')";
			...
			*/
			...
			for($i=0; $i < count($PreorderShoppingCart); $i++)
			{
				...
				{				
					...
					VALUES($pID, $ProductID, $OnlinePrice, $Num_Ordered, 'preorder')";
					
					mysql_query($sql) or die("Cannot insert purchase details from PreorderShoppingCart array [$i], please try again.");
		...
		# if a credit card transaction... do this Purchase Details insert...
			if($isCheck <> "y")
			{
				...
				$sql2 = "INSERT INTO tblPurchasePreorder(PurchaseID, Amount, DateTime, CardType, LastFourCr, BankCode, AddressVerification,
				CVV2Verification, Status)
				VALUES('$pID', '$ProductTotal', '$now', '$CardType', '$LastFourCr', '$Code', '$AVS', '$CVV2Code', 'active');";
				$result2 = mysql_query($sql2) or die("Cannot insert into tblPurchasePreorder - no check");
			...
			else
			{
				...
				$sql2 = "INSERT INTO tblPurchasePreorder(PurchaseID, Amount, DateTime, CardType, LastFourCr, BankCode, AddressVerification,
				CVV2Verification, IsCheck, BankName, RoutingNumber, CheckNumber, Status)
				VALUES('$pID', '$ProductTotal', '$now', '$CardType', '$LastFourCr', '$Code', '$AVS', '$CVV2Code', 'y', '$BankName',
				'$RoutingNumber', '$CheckNumber', 'active');";
				$result2 = mysql_query($sql2) or die("Cannot insert into tblPurchasePreorder - yes check");
			}
	...
	#-------------------------------------------	
		...
		//////////////////////
			...
			$SubS = number_format($OriginalProductTotal,2);
			$DiscountS = number_format($Discount,2);
			$ShippingS = number_format($ShipCost,2);
			$PreorderProductTotal = number_format($ProductTotal,2);
			$TotalS = $GrandTotal + $PreorderProductTotal;
			$TotalS = number_format($TotalS,2);
			$Remainder = $TotalS - $PreorderProductTotal;
		...
		<table width='800' border='0' cellspacing='0' cellpadding='0'>
		  <tr>
			<td class='main'><p><font color='#003399' size='2' face='Arial, Helvetica, sans-serif'><strong>Your
			  ...
			  <p><FONT size=+0><SPAN class=620574121-13072006><FONT face=Arial color=#000000 size=2><i>**This
			              e-mail contains important information&nbsp;about your pre-order,
              so hold onto it**</i></FONT></SPAN></FONT></p>
			  <p><font color='#000000' size='2' face='Arial, Helvetica, sans-serif'><strong>$FirstName</strong></font><font size='2' face='Arial, Helvetica, sans-serif'><strong>,
			          thank you for your reservation! Please note that your credit
			        card has only been charged $$PreorderProductTotal at this
			        time. </strong></font></p>
			  <p><font size='2' face='Arial, Helvetica, sans-serif'><a href='http://www.silenttimer.com/order/guide/ST_TimeManGuide_061405.pdf' target='_blank'>Click
			      ...
			      download<em> &quot;The
			        ...
			        timer during practice. If you have trouble
			        downloading it, please email us at <a href='mailto:info@silenttimer.com?subject=Time%20Management%20Guide%20Help'>info@silenttimer.com</a>.
			        Our <a href='http://www.silenttimer.com/timer/demo.php'>online demo</a> will also help you become more familiar with
			        The Silent Timer&#8482;. </font></p>
			  <p><font size='2' face='Arial, Helvetica, sans-serif'>You can also log in
			      ...
			      order history,  get downloads, and refer friends to earn money. Go to <a href='http://www.silenttimer.com/customerservice/'>http://www.silenttimer.com/customerservice/</a>.</font></p>
			  			  <p><font color='#0000FF'><b><font color='#003399' size='4' face='Arial, Helvetica, sans-serif'><i>What
      happens next?</i></font></b></font></p>
<table width='100%'  border='0' cellpadding='5' cellspacing='0' bordercolor='#0000FF'>
  <tr bgcolor='#FFFFCC'>
    <td><b><font color='#0000FF' size='3' face='Arial, Helvetica, sans-serif'>1.</font></b></td>
    <td><p><font size='2' face='Arial, Helvetica, sans-serif'>You will receive
          an email notification within one week of the product being shipped.
          At that time, you will be given the opportunity of changing your shipping
          option, and we will confirm your shipping address. </font></p>
      <p><font size='2' face='Arial, Helvetica, sans-serif'>The estimated ship date is September 11, 2006. It is likely that the ship
        date will be earlier. </font></p></td>
  </tr>
  <tr bgcolor='#FFFFCC'>
    <td><b><font color='#0000FF' size='3' face='Arial, Helvetica, sans-serif'>2.</font></b></td>
    <td><font size='2' face='Arial, Helvetica, sans-serif'>Your card will be
        charged the remaining balance (see below) on the day before your product
        is shipped. You will get an email receipt confirming payment. </font></td>
  </tr>
  <tr bgcolor='#FFFFCC'>
    <td><b><font color='#0000FF' size='3' face='Arial, Helvetica, sans-serif'>3.</font></b></td>
    <td><font size='2' face='Arial, Helvetica, sans-serif'>Once your item is shipped, you will receive an email with tracking information.</font></td>
  </tr>
</table>
			  <p><b><font size='3' face='Arial, Helvetica, sans-serif'>ORDER SUMMARY </font></b></p>
			  ...
			  <table width='100%' border='1' cellpadding='4' cellspacing='0' bordercolor='#003399'>
				...
				<tr> 
				  <td align='left' valign='top'><p><font color='#000000' size='2' face='Arial, Helvetica, sans-serif'>$FirstName
				        $LastName</font><font color='#000000' size='2' face='Arial, Helvetica, sans-serif'><br>
				...
				<table width='100%' border='1' cellpadding='4' cellspacing='0' bordercolor='#003399'>
					<tr><td width='55%' align='left' valign='top' bgcolor='#003399' colspan = '4'><font size='2'><strong>
				    <font face='Arial, Helvetica, sans-serif'><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>Order
				    Summary</font></strong> </font></td></tr>
			...
			for($i=0; $i < count($PreorderShoppingCart); $i++)
			{
				...
				{				
					...
					while($row = mysql_fetch_array($result))
					{
						...
						if($Preorder == "y")
						{
						$PreorderProductTotal = $Num_Ordered * $PreorderPrice;
						$PreorderProductTotal = number_format($PreorderProductTotal,2);
						}
					...
					<tr>
                      <td colspan='3'><b><font size='2' face='Arial, Helvetica, sans-serif'>Order
                          Total</font></b></td>
                      <td><b><font size='2' face='Arial, Helvetica, sans-serif'>$$TotalS</font></b></td>
  </tr>
					<tr>
                      <td colspan='3'><font size='2' face='Arial, Helvetica, sans-serif'>Reservation
                      Fee (already paid for) </font></td>
                      <td><font size='2' face='Arial, Helvetica, sans-serif'>-$$PreorderProductTotal</font></td>
  </tr>
					<tr>
					  <td colspan='3'><b><font size='2' face='Arial, Helvetica, sans-serif'>Remaining
				      Balance (to be charged when item is shipped) </font></b></td>
					  <td><b><font size='2' face='Arial, Helvetica, sans-serif'>$$Remainder</font></b></td>
					</tr></table>
				<br>
				<table width='100%'  border='0' cellpadding='5' cellspacing='0' bgcolor='#FFFFCC'>
                  <tr>
                    <td><b><font size='2' face='Arial, Helvetica, sans-serif'>Your
                          card has only been charged $$PreorderProductTotal at this time.
                          The remaining $$Remainder will be charged upon shipment.
                    Email us or call us if you have any questions.</font></b></td>
                  </tr>
                </table>
				<p>
				";
		...
		$html .= "
				...
				<table width='100%' border='1' cellspacing='0' cellpadding='5' bordercolor='#003399'>
				  ...
				  <font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'><font size='2' face='Arial, Helvetica, sans-serif'>Promotion Information</font></strong></td></tr>
					<tr>
		...
		$html .= "
		<font color='#000000' size='2' face='Arial, Helvetica, sans-serif'>$FirstNameB
		$LastNameB</font><font color='#000000' size='2' face='Arial, Helvetica, sans-serif'><br>
$AddressB<br>
$CityB, $StateB $ZipCodeB<br>
$CountryNameB</font></p>
		";
		}
		else
		{
		$html .= "<font color='#000000' size='2' face='Arial, Helvetica, sans-serif'>Same
		As Shipping</font>";
		}
		...
		"
		 ...
		 # Get shipping info
				...
				<tr><td width='60%' align='left' valign='top' bgcolor='#003399' colspan='4'> <strong>
				  <font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>Shipping Option</strong></td>
				</tr>
				<tr bgcolor='#CCCCCC'>
           </tr>
          <tr bgcolor='#CCCCCC'>
		...
		$html .= "
		<p><font size='2' face='Arial, Helvetica, sans-serif'>If you have any questions at all, please email us.</font>
		...
		1. You will receive an email notification within one week of the product being shipped. At that time, you will be given the opportunity of changing your shipping option, and we will confirm your shipping address. 
			The estimated ship date is September 11, 2006. It is likely that the ship date will be earlier. 
		2. Your card will be charged the remaining balance on the day before your product is shipped. You will get an email receipt confirming payment.  
		3. Once your item is shipped, you will receive an email with tracking information.
		...
		Your card was only charged $$PreorderProductTotal.  The remaining $$Remainder will be charged upon shipment.  Email or call us if you have any questions.
		...
		$mail->IsHTML(false);
		$mail->Subject = "PREORDER - $pID: $FirstName $LastName spent $$TotalS!";
		...
		Amount Charged:	   $PreorderProductTotal
		Remainder:		   $Remainder
...
<table width="100%"  border="0" cellspacing="0" cellpadding="5">
  ...
  * <em><font color="#666666">Please be aware your e-mail provider may filter
  ...
  Safe Email list.*</font></em></font></p>
      <p><font color="#0000FF" size="4" face="Arial, Helvetica, sans-serif"><b>What
            happens next?</b></font></p>
      <table width="100%"  border="0" cellpadding="5" cellspacing="0" bordercolor="#0000FF">
        <tr bgcolor="#FFFFCC">
          <td><b><font color="#0000FF" size="3" face="Arial, Helvetica, sans-serif">1.</font></b></td>
          <td><p><font size="2" face="Arial, Helvetica, sans-serif">You will
                receive an email notification within one week of the product
                being shipped. At that time, you will be given the opportunity
                of changing your shipping option, and we will confirm your shipping
                address. </font></p>
              <p><font size="2" face="Arial, Helvetica, sans-serif">The estimated
                  ship date is September 11, 2006.</font></p></td>
        </tr>
        <tr bgcolor="#FFFFCC">
          <td><b><font color="#0000FF" size="3" face="Arial, Helvetica, sans-serif">2.</font></b></td>
          <td><font size="2" face="Arial, Helvetica, sans-serif">Your card will
              be charged the remaining balance on the day before your product
              is shipped. You will get an email receipt confirming payment. </font></td>
        </tr>
        <tr bgcolor="#FFFFCC">
          <td><b><font color="#0000FF" size="3" face="Arial, Helvetica, sans-serif">3.</font></b></td>
          <td><font size="2" face="Arial, Helvetica, sans-serif">Once your item
              is shipped, you will receive an email with tracking information.</font></td>
        </tr>
      </table>
...
<p><font size="2" face="Arial, Helvetica, sans-serif">Please help spread
...
<table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#003399">
 ...
 <tr><td><table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#003399">
     <tr bgcolor="#CCCCCC">
 ...
 # loop out all shopping cart items
     ...
     <tr>
       <td><div align="center" >
             ...
             <font size="2" face="Arial, Helvetica, sans-serif"><? echo $Num_Ordered; ?></font>             <br>
          </div></td>
...
<form action="preorder4.php<? if($Custom=="yes"){echo "?a=$affiliateID";}?>" method="post" name="frmBack" id="frmBack">
  <div align="right"> 
...
", "From:$FirstName $LastName<$Email>");
	...
	?>
		...
		<p><font size="2" face="Arial, Helvetica, sans-serif">If you have reached this page in 
		  error and would actually like to place your order again, please <a href="preorder.php">click 
		  here</a>.</font></p>
