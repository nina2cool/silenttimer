...
<table width="100%"  border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <table width="100%"  border="0" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
      <tr>
        <td><p align="center"><font size="2" face="Arial, Helvetica, sans-serif"><em>Take
              the <a href="<? echo $http; ?>survey/survey0525a.php">Time Management
              Survey</a> and <br>
              be entered in a monthly drawing to win a $25 gift
              certificate!</em></font></p>
            <p align="center"><em><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>survey/survey0525a.php">Take
                  the Survey</a> | <a href="<? echo $http; ?>survey/surveyinfo.php">Learn
                  More</a></font></em></p></td>
        <td><p align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>survey/survey0525a.php"><img src="pics/Survey.jpg" width="67" height="67" border="0"></a></font></p></td>
      </tr>
    </table></td>
  </tr>
</table>
