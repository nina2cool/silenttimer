...
if ($auth=="Y")
{
			...
			for($i=0; $i < count($ShoppingCart); $i++)
			{
				...
				{				
					...
					$sql = "UPDATE tblProduct2 SET WebOnHand = WebOnHand - $Num_Ordered WHERE ProductID = $ProductID";
					mysql_query($sql) or die("Cannot update Web Inventory, please try again.");
					
					# Get all information from table for this part number ID
					$sql = "SELECT * FROM tblProduct2 WHERE ProductID='$ProductID'";
