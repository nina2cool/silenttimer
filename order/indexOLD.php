...
<table width="100%" border="0" cellspacing="0" cellpadding="6">
  <tr align="left" valign="top"> 
    <td width="623"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="20%" valign="top"><img src="pics/Front-Logo-blue.jpg" alt="The Silent Timer Order Page"></td>
          <td width="80%" align="left" valign="top"><font size="5" face="Arial, Helvetica, sans-serif"><strong>Order 
            Form <br>
      ...
      <? if($PromoNote != ""){ ?>
      <br>
      <table width="80%" border="1" align="center" cellpadding="1" cellspacing="0" bordercolor="#CC0000">
        <tr> 
          <td align="left" valign="top"> <p><font color="#CC0000" size="2" face="Arial, Helvetica, sans-serif"><strong><em>Special 
              Promotion</em></strong></font><br>
            </p>
            <p align="left"><font color="#CC0000" size="4" face="Arial, Helvetica, sans-serif"><strong><? echo $PromoNote;?></strong></font></p></td>
        </tr>
      </table>
      <? }?>
          ...
          <tr align="left" valign="top"> 
            <td><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">Number 
              ...
              <select name="cboNum" id="cboNum">
                ...
                <option value="7" <? if($Num == "7"){echo "selected";}?>>7</option>
                <option value="8" <? if($Num == "8"){echo "selected";}?>>8</option>
                <option value="9" <? if($Num == "9"){echo "selected";}?>>9</option>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="8">
          ...
          <tr align="left" valign="top"> 
            <td colspan="2"> <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="26%" align="left" valign="top"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>City 
                    * </strong><br>
                    <input name="txtCity" type="text" id="txtCity" size="15" value="<? echo addQuote($City);?>">
                    </font></td>
                  <td width="40%"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>State 
                    * </strong><br>
          ...
          <tr align="left" valign="top"> 
            <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#000033">Phone 
              ...
              code + Phone Number</font><font color="#999999">. No dashes or spaces. 
              Only numbers)</font></font></td>
          </tr>
          <tr align="left" valign="top"> 
            ...
            <tr align="left" valign="top"> 
              <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    ...
                    <td width="40%"><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>State 
                      * </strong><br>
                      <select name="txtStateB" class="text">
                        <option value = "" selected>Please Select</option>
                        <?  
						// build combo box for states in DB
						// SQL to get data from shippingoption and shipper table
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="8">
          ...
          <tr align="left" valign="top">
            <td><font size="2" face="Arial, Helvetica, sans-serif">When is your 
              test date? Use the calendar popup for easy selection.<br>
              <SCRIPT LANGUAGE="JavaScript">
				var now = new Date();
				var calendar = new CalendarPopup("calendarDiv");
			  </SCRIPT>
              <a name="calendarPosition" id="calendarPosition"> </a>
			  <input type="text" name="txtTestDate" value="<? if($TestDate != ""){echo $TestDate;}else{echo "yyyy-mm-dd";}?>" size="15" onfocus='if(this.value == "yyyy-mm-dd") this.value = ""' onblur='if(this.value == "") this.value = "yyyy-mm-dd"'>
              <A HREF="#" onClick="calendar.select(document.forms[0].txtTestDate,'calendarPosition','yyyy-MM-dd'); return false;">Calendar PopUp</A></font>
			</td>
          </tr>
          <tr align="left" valign="top"> 
