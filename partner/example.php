...
<p align="left"><font size="2" face="Arial, Helvetica, sans-serif">Here are several 
  examples of what you could add to your site. We have included images, the importance 
  of timing yourself during practice, and the importance of security on test day. 
  These are only a few examples and can be used as a starting point. You may create 
  something similar or completely different for your site. </font></p>
<p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Here 
  are some detailed explanations and some simple link combinations:</strong></font></p>
...
<table width="100%" border="1" cellpadding="8" cellspacing="0" bordercolor="#003399">
  <tr>
    <td><table width="100" border="0" cellspacing="0" cellpadding="8" class="right">
        <tr>
          <td><div align="center">
              <table width="10" border="2" cellpadding="0" cellspacing="0" bordercolor="#000000">
                <tr>
                  <td><div align="center"><a href="http://www.SilentTimer.com/order?a=partnercode" target="_blank"><img src="home/images/lsat/LSAT_improve_250x250.jpg" width="250" height="250" border="0"></a></div></td>
                </tr>
              </table>
            </div></td>
        </tr>
      ...
      you need a timer.</strong></font> <p><font size="2" face="Arial, Helvetica, sans-serif">One 
        of the reasons the LSAT is so difficult is the time constraint. The LSAT 
        is a grueling, three and a half hour exam. Each multiple choice section 
        is 35 minutes long with an average of 25 questions. This gives you approximately 
        1 minute and 24 seconds to answer every difficult question. On some questions 
        you only have 40 seconds. Yikes.</font></p>
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><font size="4">Get 
        ...
        </strong><a href="http://www.SilentTimer.com/order?a=<? echo $aID;?>" target="_blank"><strong>The 
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><a href="http://www.SilentTimer.com/order?a=<? echo $aID;?>" target="_blank">Get 
    ...
    <td><table width="100" border="0" cellspacing="0" cellpadding="8" class="right">
        <tr> 
          <td><div align="center"> 
              <table width="10" border="2" cellpadding="0" cellspacing="0" bordercolor="#000000">
                <tr> 
                  <td><div align="center"><a href="http://www.SilentTimer.com/order?a=partnercode" target="_blank"><img src="home/images/mcat/MCAT_250x250.jpg" width="250" height="250" border="0"></a></div></td>
                </tr>
              </table>
            </div></td>
        </tr>
      </table>
      <font size="4" face="Arial, Helvetica, sans-serif"><strong>Timing on your 
      MCAT</strong></font> <p><font size="2" face="Arial, Helvetica, sans-serif">One 
        of the reasons the MCAT is so difficult is the time constraint.</font></p>
      <p><font size="2" face="Arial, Helvetica, sans-serif"><em><strong>In fact</strong></em>, 
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><font size="4">Get 
        your Timer Here</font><br>
        </strong><a href="http://www.SilentTimer.com/order?a=<? echo $aID;?>" target="_blank">The 
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><a href="http://www.SilentTimer.com/order?a=<? echo $aID;?>" target="_blank">Click 
    ...
    <td><table width="100" border="0" cellspacing="0" cellpadding="8" class="right">
        <tr> 
          <td><div align="center"> 
              <table width="10" border="2" cellpadding="0" cellspacing="0" bordercolor="#000000">
                <tr> 
                  <td><div align="center"><a href="http://www.SilentTimer.com/order?a=partnercode" target="_blank"><img src="home/images/sat/SAT_timing_125x125.jpg" width="125" height="125" border="0"></a></div></td>
                </tr>
              </table>
            </div></td>
        </tr>
      ...
      <font size="4" face="Arial, Helvetica, sans-serif"><strong>Timing on your 
      SAT</strong></font> <p><font size="2" face="Arial, Helvetica, sans-serif">One 
        of the reasons the SAT is so difficult is the time constraint. It is tough 
        to answer all of those questions before time is up!</font></p>
      <p><font size="2" face="Arial, Helvetica, sans-serif"><em><strong>In fact</strong></em>, 
...
<table width="100%" border="1" cellpadding="8" cellspacing="0" bordercolor="#003399">
  <tr> 
    <td><p><font size="4" face="Arial, Helvetica, sans-serif"><strong>GMAT</strong></font> 
      ...
      <table width="100" border="0" cellspacing="0" cellpadding="8">
        <tr> 
          <td><div align="center"> 
              <table width="10" border="2" cellpadding="0" cellspacing="0" bordercolor="#000000">
                <tr> 
                  <td><div align="center"><a href="http://www.SilentTimer.com/order?a=partnercode" target="_blank"><img src="home/images/gmat/GMAT_timer4_250x250.jpg" width="250" height="250" border="0"></a></div></td>
                </tr>
              </table>
            </div></td>
        </tr>
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong><font size="4">Get 
        your Timer Here</font><br>
        </strong><a href="http://www.SilentTimer.com/order?a=partnercode" target="_blank">The 
        Silent Timer&#8482;</a> is a special testing timer we suggest you get 
        for your GMAT practice. It has cool features to help you manage your test 
        time.<strong><font size="4"> </font><a href="http://www.SilentTimer.com/order?a=partnercode" target="_blank">Click 
