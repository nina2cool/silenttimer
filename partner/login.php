...
$PageTitle = "Silent Timer Partner - Login";
...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
?> <font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Partner Login</strong></font></p> 
<?
		if ($errLogin == 1)
		{
			echo "<p>";
...
<form name="frmLogin" method="post" action="">
  ...
  <table width="400" border="0" cellspacing="0" cellpadding="5">
    ...
    <tr> 
      <td colspan="2" align="left" valign="top"><font size="2" face="Arial, Helvetica, sans-serif"><a href="password.php">&gt; 
        Forgot your password?</a></font></td>
    </tr>
  </table>
              </form>
