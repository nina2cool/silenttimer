...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	//echo $sql;
	$result = mysql_query($sql) or die("Cannot execute query1!");
	...
	if($ImageType <> "all")
	{
			...
			$sql2 = "SELECT * FROM tblAffGallery WHERE Category = '$ImageType'";
			//echo $sql2;
...
<?
	...
	{
	// build SQL for images on page...
			$sql3 = "SELECT * FROM tblAffGallery ORDER BY Category";
