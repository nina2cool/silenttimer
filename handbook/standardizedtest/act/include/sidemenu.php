    ...
    <TD width="161" align="left" valign="top" background="<? echo $http; ?>images/behind-left-gray.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <table width="100%" border="0" cellpadding="6" cellspacing="0" bordercolor="#000000">
            ...
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/act/index.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT 
                  Test </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_test_prep.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT 
                  Test Prep</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_practice_test.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT 
                  Practice Tests</font></a></div></td>
            </tr>
            <tr>
              <td align="left" valign="top" class="box1"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_registration.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT
              Registration</font></a></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_score.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT 
                  Score </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_software.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT 
                  Software </font></a></div></td>
            </tr>
            <tr>
              <td align="left" valign="top" class="box1"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_test_dates.php"><font size="2" face="Arial, Helvetica, sans-serif">ACT 
                Test Dates</font></a></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/act/act_st.php"><font size="2" face="Arial, Helvetica, sans-serif">THE 
