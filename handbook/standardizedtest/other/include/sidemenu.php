    ...
    <TD width="161" align="left" valign="top" background="<? echo $http; ?>images/behind-left-gray.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <table width="100%" border="0" cellpadding="6" cellspacing="0" bordercolor="#000000">
            ...
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/other/index.php"><font size="2" face="Arial, Helvetica, sans-serif">Tests 
                  Intro</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/other/juniorhigh_tests.php"><font size="2" face="Arial, Helvetica, sans-serif">Junior 
                  High Tests</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/other/highschool_tests.php"><font size="2" face="Arial, Helvetica, sans-serif">High 
                  School Tests</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/other/college_tests.php"><font size="2" face="Arial, Helvetica, sans-serif">College 
                  Tests </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/other/college_essays.php"><font size="2" face="Arial, Helvetica, sans-serif">College 
                  Essays</font></a></div></td>
            </tr>
            <tr>
              <td align="left" valign="top" class="box1"><a href="<? echo $http; ?>handbook/standardizedtest/other/professional_tests.php"><font size="2" face="Arial, Helvetica, sans-serif">Professional 
                Tests</font></a></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/silent_timer/index.php"><font size="2" face="Arial, Helvetica, sans-serif">THE 
