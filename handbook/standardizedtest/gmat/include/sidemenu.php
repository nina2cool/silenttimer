    ...
    <TD width="161" align="left" valign="top" background="<? echo $http; ?>images/behind-left-gray.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <table width="100%" border="0" cellpadding="6" cellspacing="0" bordercolor="#000000">
            ...
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/"><font size="2" face="Arial, Helvetica, sans-serif">GMAT 
                  Test </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_prep.php"><font size="2" face="Arial, Helvetica, sans-serif">GMAT 
                  Prep Course</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_score.php"><font size="2" face="Arial, Helvetica, sans-serif">GMAT 
                  Score </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_practice.php"><font size="2" face="Arial, Helvetica, sans-serif">GMAT 
                  Preparation </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_practice_test.php">GMAT 
                Practice Tests</a></font></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_registration.php">GMAT 
                Registration</a></font></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_test_date.php">GMAT 
                Test Date</a></font></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/gmat/gmat_st.php"><font size="2" face="Arial, Helvetica, sans-serif">THE 
