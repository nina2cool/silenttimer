    ...
    <TD width="161" align="left" valign="top" background="<? echo $http; ?>images/behind-left-gray.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <table width="100%" border="0" cellpadding="6" cellspacing="0" bordercolor="#000000">
            ...
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/index.php"><font size="2" face="Arial, Helvetica, sans-serif">MCAT 
                  Test</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_test_prep.php"><font size="2" face="Arial, Helvetica, sans-serif">MCAT 
                  Test Prep</font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_score.php"><font size="2" face="Arial, Helvetica, sans-serif">MCAT 
                  Score </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_practice.php"><font size="2" face="Arial, Helvetica, sans-serif">MCAT 
                  Preparation </font></a></div></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_practice_test.php">MCAT 
                Practice Tests</a></font></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_registration.php">MCAT 
                Registration</a></font></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_test_dates.php">MCAT 
                Test Dates</a></font></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class="box1"><div align="left"><a href="<? echo $http; ?>handbook/standardizedtest/mcat/mcat_st.php"><font size="2" face="Arial, Helvetica, sans-serif">THE 
