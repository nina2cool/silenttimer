...
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">This is 
  ...
  customers.<br>
  <br>
  Check the <a href="allcustomers.php">list of all of our customers</a> to make 
  sure there are no duplications of entries.</font></p>
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Click on 
  the headings to sort the list.</font></p>
...
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  ...
  <?
			  ...
			  ?>
  <tr> 
    <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="editcustomers.php?c=<? echo $cID; ?>"><strong>Details</strong></a></font></div></td>
...
<p><font size="3" face="Arial, Helvetica, sans-serif">&gt;&gt;<a href="addcustomer.php">Add 
  New Customer</a><br>
  <br>
  &lt;&lt;<a href="home.php">Back to Employee Home Page</a></font> </p>
<p><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">*Note: This 
  customer list is for Business Customers. This <em><strong>not</strong></em> 
  for individuals who purchased a single timer from you. Those are tracked in 
  a separate database. If you have individual customers, just submit their orders 
  using the Individual Customer Order Form or have them order online.</font></p>
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong><br>
  Customer Contact Log</strong></font></p>
<p><font size="2" face="Arial, Helvetica, sans-serif">When you contact a customer, 
  be sure to log all communications in your &quot;Customer Contact Log.&quot; 
  An online version will be available sometime soon, but until then use the Excel 
  spreadsheet. If you did not receive your &quot;Customer Contact Log&quot;, <a href="mailto:nina@silenttimer.com">email 
  Christina</a>.</font></p>
<p><font size="2" face="Arial, Helvetica, sans-serif">All you need to do is record 
  the details of the communication, such as: Business Name, Contact Name, Type 
  of Contact (Email, phone, etc), Phone # or email address, the date and time 
  of the contact, and the results. Write down everything discussed, even if all 
  you did was leave a message. It can get confusing when talking to lots of different 
  customers.</font></p>
<p><font size="2" face="Arial, Helvetica, sans-serif">If you have any questions, 
  just ask Christina or Erik.</font></p>
<p>&nbsp;</p>
<p> 
<?
