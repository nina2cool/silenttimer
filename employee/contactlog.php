...
$PageTitle = "View Your Contact Log";
...
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  ...
  <tr bgcolor="#FFFFCC"> 
    ...
    <td width="16%" class=sort> <div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="customers.php?sort=tblBusinessCustomer.ContactName&d=<? if ($sortBy=="tblBusinessCustomer.ContactName") {echo $sd;} else {echo "ASC";} ?>">Contact 
        Name </a></font></strong></font></div></td>
    <td width="17%" class=sort> <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="customers.php?sort=tblBusinessCustomer.OfficePhone1&d=<? if ($sortBy=="tblBusinessCustomer.OfficePhone1") {echo $sd;} else {echo "ASC";} ?>">Date 
        and Time</a></strong></font></div></td>
    <td width="18%" class=sort> <div align="center"><font color="#003399" face="Arial, Helvetica, sans-serif"><strong><font size="2"><a href="customers.php?sort=tblBusinessCustomer.Fax&d=<? if ($sortBy=="tblBusinessCustomer.Fax") {echo $sd;} else {echo "ASC";} ?>">Log 
        Entry </a></font></strong></font></div></td>
    <td width="16%" class=sort> <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="customers.php?sort=tblBusinessCustomer.BusinessType&d=<? if ($sortBy=="tblBusinessCustomer.BusinessType") {echo $sd;} else {echo "ASC";} ?>">Notes</a></strong></font></div></td>
  </tr>
  <?
