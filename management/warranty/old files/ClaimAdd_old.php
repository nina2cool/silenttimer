	  ...
	  If ($_POST['Submit'] == "Add")
	   {
		...
		DateNewProductSent, ProblemConclusion, ReturnToChina, Notes, Status, NumReturned)
		...
		'$ReturnToChina', '$Notes', '$Status', '$NumReturned')";
          ...
          <tr> 
            <td><table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
                ...
                <tr> 
                  ...
                  <td><input name="txtPurchaseID" type="text" id="txtPurchaseID5"></td>
                </tr>
                <tr> 
                  ...
                  <td><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                    <input name="txtCustomerType" type="text" id="txtCustomerType4">
                    </font></strong></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                    <input name="txtShipmentCodeRequested" type="text" id="txtShipmentCodeRequested4" size="5" maxlength="4">
                    </font></strong></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                    <input name="txtAuthorizationCode" type="text" id="txtAuthorizationCode4" value="AUTH/TKT">
                    </font></strong></td>
                </tr>
                <tr> 
