    ...
    <TD width="161" align="left" valign="top" background="../images/behind-left-gray.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <table width="100%" border="0" cellpadding="6" cellspacing="0" bordercolor="#000000">
            ...
            <tr> 
              <td align="left" valign="top" class=box1><div align="right"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>faq2/index.php"> 
                  &lt;&lt; FAQ Home </a></font></div></td>
            </tr>
            <tr> 
            ...
            <tr> 
              <td align="left" valign="top" class=box1><a href="<? echo $http; ?>faq2/index.php"><font size="2" face="Arial, Helvetica, sans-serif">Categories</font></a></td>
            </tr>
            <tr> 
              <td align="left" valign="top" class=box1><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>faq2/CategoryAdd.php">Add
                      a Category</a></font></div></td>
            </tr>
            <tr>
