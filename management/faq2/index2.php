...
require "../include/dbinfo.php";
	...
	$sql = "SELECT tblCategory.Name, tblCategory.CategoryID
	 FROM tblCategory WHERE Type = 'Category'";
	...
	{
		$sql .= " ORDER BY tblCategory.CategoryID ASC";
		$sortBy ="tblCategory.CategoryID";
		$sortDirection = "ASC";
	}
	...
	$result = mysql_query($sql) or die("Cannot execute query!<br><br>$sql<br><br>" . mysql_error());


		

?>
<p><font color="#000000" size="5" face="Arial, Helvetica, sans-serif"><strong>View 
  Categories</strong></font></p>
...
?>
    <tr valign="top"> 
      ...
      <td> <div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">View 
          Subcategories </font></strong></div></td>
	...
	?>
    <tr> 
      <td> <a href="../categories/CategoryEdit.php?cat=<? echo $CategoryID; ?>"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Category; ?><br>
        </font></a></td>
      <td><div align="center"><a href="../categories/SubcategoryView.php?cat=<? echo $CategoryID; ?>"><font size="2" face="Arial, Helvetica, sans-serif">View 
          Subcategories</font></a></div></td>
      <td width="10%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><b><a href="index.php?Delete=YES&CategoryID=<? echo $CategoryID; ?>">X</a><font color="#FF0000">*</font></b></font></div></td>
      <?
  ...
  <p><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">*If you
       ...
       products will no longer be available to our customers. If this happens, <a href="mailto:nina@silenttimer.com">email
        Christina</a> to fix it (can't just be re-added, needs to have same ID
        number).</font></p>
  <p><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif">Deleting 
    ...
    not deleted, but the products they are attached to will not be available to 
    customers. </font></p>
  <br>
