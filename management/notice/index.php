...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT * FROM tblNotice WHERE Status = 'active'";
...
?>
  <tr valign="top">
    ...
    <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Pages</font></strong></td>
  ...
  <tr>
    ...
    <td><font size="2" face="Arial, Helvetica, sans-serif">Home: <?php echo $HomePage; ?><br>
      Product: <?php echo $ProductPage; ?><br>
      Order2: <?php echo $Order2Page; ?><br>
    Receipt Page: <?php echo $ReceiptPage; ?>    </font></td>
