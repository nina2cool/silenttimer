...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	//beginning SQL statement that gets all data from tables.
	$sql = "SELECT * from tblEmployee WHERE Status = 'active'";
...
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#CCCCCC">
  ...
  <tr> 
    ...
    <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $CellPhone; ?></font></div></td>
    <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><a href="mailto:<? echo $Email; ?>"><? echo $Email; ?></a></font></div></td>
    <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Type; ?></font></div></td>
  </tr>
  <?
			  	}
...
<p><font size="2" face="Arial, Helvetica, sans-serif">&gt; <a href="EmployeeInactiveView.php">View 
  Inactive Employees</a></font></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p> 
  <?
