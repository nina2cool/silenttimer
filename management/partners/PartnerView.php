...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT tblAffiliate.AffiliateID, tblAffiliate.FirstName, tblAffiliate.LastName, tblAffiliate.CompanyName, tblAffiliate.Status,
			...
			WHERE tblAffiliate.Status = 'active'";
...
?>
    <tr bgcolor="#FFFFCC"> 
      ...
      <td class=sort> 
        <div align="center"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif">Contact 
          Name</font></strong></div></td>
      <td class=sort> 
        <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>Total
        Sales to Date</strong></font></div></td>
      <td class=sort> 
        <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>Total
        Commissions to Date</strong></font></div></td>
      <?
			  $sql3 = "SELECT * FROM tblAffiliate WHERE Status = 'active'";
			  ...
			  ?>
    <tr> 
      <td> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="PartnerInfo.php?aff=<? echo $AffID; ?>">Details</a></font></div></td>
      <td>
<div align="center">
  <p><font size="2" face="Arial, Helvetica, sans-serif"><? echo $AffID; ?><br>
    <a href="mailto:<? echo $Email; ?>?subject=Silent%20Timer%20Affiliate%20Program">EMAIL<br>
    </a></font><font size="2" face="Arial, Helvetica, sans-serif"><a href="email.php?affiliate=<? echo $AffID; ?>" target="_blank">LETTER</a><br>
    <a href="final_letter.php?affiliate=<? echo $AffID; ?>" target="_blank">FINAL</a></font></p>
  </div></td>
      ...
      <td><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">$ <? echo number_format($TotalSale,2); ?></font></div></td>
      <td><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">$ <? echo number_format($Commission,2); ?></font></div></td>
    </tr>
    <?
			  	}
  ...
  <p align="left"><b><font size="2" face="Arial, Helvetica, sans-serif">&gt; <a href="PartnerViewInactive.php">Inactive 
