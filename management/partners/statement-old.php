...
<table width="409" border="0" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC">
  <tr> 
    ...
    <td width="62%"><font size="2" face="Arial, Helvetica, sans-serif">$</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><? echo number_format($TotalCommission,2); ?></font></td>
  </tr>
  <tr> 
    ...
    <td valign="top"> <strong><font size="3" face="Arial, Helvetica, sans-serif">SUMMARY 
      ...
      <table width="375" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
        ...
        <?
			  ...
			  $sql4 = "SELECT * FROM tblAffiliatePurchase WHERE AffiliateID = '$AffID' AND Status = 'open'";
...
<p><br>
  ...
  If you have any questions, please call Christina Dilly at <?php echo $CPhone2; ?>. Thank 
  you!</font></p>
