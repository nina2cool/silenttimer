...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT * FROM tblPromotionCode";
...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>View
      All Promotion Codes </strong></font></p>
...
?>
  <tr valign="top">
    <td><div align="left"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="PromoViewAll.php?sort=tblPromotionCode.PromotionCodeID&d=<? if ($sortBy=="tblPromotionCode.PromotionCodeID") {echo $sd;} else {echo "ASC";}?>">Promo
            Code</a> </font></strong></div></td>
    <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="PromoViewAll.php?sort=tblPromotionCode.StartDate&d=<? if ($sortBy=="tblPromotionCode.StartDate") {echo $sd;} else {echo "ASC";}?>">Start
          Date</a>      - <a href="PromoViewAll.php?sort=tblPromotionCode.EndDate&d=<? if ($sortBy=="tblPromotionCode.EndDate") {echo $sd;} else {echo "ASC";}?>">End
          Date</a></font></strong></td>
    <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="PromoViewAll.php?sort=tblPromotionCode.PromotionID&d=<? if ($sortBy=="tblPromotionCode.PromotionID") {echo $sd;} else {echo "ASC";}?>">Type</a> / <a href="PromoViewAll.php?sort=tblPromotionCode.Amount&d=<? if ($sortBy=="tblPromotionCode.Amount") {echo $sd;} else {echo "ASC";}?>">Amount</a> </font></strong></td>
  ...
  <?
   ...
   <tr <? if($Status ==  'cancel') { ?>bgcolor="#999966"<? } ?>>
    <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $PromotionCodeID; ?></font></div></td>
