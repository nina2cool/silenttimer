...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr valign="top"> 
    <td><p><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>&gt;
          ...
          <br>
          </a></strong></font><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="custpackinglist_all_new.php?s=6" target="_blank">DHL</a> |  <a href="custpackinglist_all_new.php?s=8" target="_blank">USPS</a> | <a href="custpackinglist_all_new.php?s=11" target="_blank">FedEx</a> | <a href="custpackinglist_all_new.php?s=9" target="_blank">UPS</a><br>
          </strong></font><font size="2" face="Arial, Helvetica, sans-serif"><strong><a href="ShippingSummary.php" target="_blank">Shipping
          Summary</a></strong></font><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>          </strong></font></p>    </td>
    <td><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>&gt; <a href="custpackinglist_all_noretail.php" target="_blank">Packing Lists Only</a><a href="custpackinglist_all_new_test.php" target="_blank"><br />
          <br />
          </a></strong></font><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="custpackinglist_all_noretail.php?s=6" target="_blank">DHL</a> | <a href="custpackinglist_all_noretail.php?s=8" target="_blank">USPS</a> | <a href="custpackinglist_all_noretail.php?s=11" target="_blank">FedEx</a> | <a href="custpackinglist_all_noretail.php?s=9" target="_blank">UPS</a></strong></font></td>
    <td><p><font size="2" face="Arial, Helvetica, sans-serif"><strong>&gt; 
        </strong><a href="PostOffice.php" target="_blank"><strong>Post Office
        Orders</strong></a><strong> | <a href="PostOfficeDHL.php" target="_blank">DHL Orders</a></strong><a href="PostOffice.php" target="_blank"><strong><br>
      ...
      on Backorder<br>
        ...
        to be Shipped</strong></a></font></p>    </td>
  </tr>
</table>
...
if($CountryID == '225' OR $CountryID == '241' OR $CountryID == '242' OR $CountryID == '243')
{
  ...
  <tr>
    ...
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="PurchaseDetails.php?purch=<? echo $PurchaseID; ?>&cust=<? echo $CustomerID; ?>"><? echo $PurchaseID; ?></a></font></div></td>
...
<? 
			...
			tblCustomer.StateOther, tblCustomer.Type,
			tblPurchase2.PurchaseID, tblPurchase2.CustomerID, tblPurchase2.ShipNotes,
			tblPurchase2.ShipCostID, tblPurchase2.Status, tblPurchase2.Shipped, tblPurchase2.PONumber, tblPurchase2.InvoiceNumber
			FROM tblCustomer INNER JOIN tblPurchase2
			ON tblCustomer.CustomerID = tblPurchase2.CustomerID
			INNER JOIN tblShippingCost5
			ON tblPurchase2.ShipCostID = tblShippingCost5.ShipCostID
...
?>
  <tr bgcolor="#C7F1C7">
    ...
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView.php?sort=tblCustomer.State&d=<? if ($sortBy=="tblCustomer.State") {echo $sd;} else {echo "ASC";}?>">St.</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView.php?sort=tblCustomer.ZipCode&d=<? if ($sortBy=="tblCustomer.ZipCode") {echo $sd;} else {echo "ASC";}?>">Zip</a></strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> PO/Inv#</strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> <a href="NotShippedView.php?sort=tblShippingCost5.ShippingOptionID&d=<? if ($sortBy=="tblShippingCost5.ShippingOptionID") {echo $sd;} else {echo "ASC";}?>">Code</a>/<a href="NotShippedView.php?sort=tblShippingCost5.ShipperID&d=<? if ($sortBy=="tblShippingCost5.ShipperID") {echo $sd;} else {echo "ASC";}?>">Shipper</a></strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> Ship Notes</strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong>Products</strong></font></div></td>
    <?
				...
				$PONumber = $row21['PONumber'];
				$InvoiceNumber = $row21['InvoiceNumber'];


				if($CompanyName == "")  {  $CompanyName = "<br> ";  }
				if($LastName == "")  {  $LastName = "<br> ";  } 
				if($ShipNotes == "")  {  $ShipNotes = "<br> ";  }
				if($State == "ZZ")  {  $State = $StateOther;  }
  ...
  <tr>
    ...
    <td><font size="1" face="Arial, Helvetica, sans-serif"><? echo $State; ?></font></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? echo $ZipCode; ?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? echo $PONumber; ?></font>/<font size="1" face="Arial, Helvetica, sans-serif"><? echo $InvoiceNumber; ?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? echo $ShipperNickname; ?>-<? echo $ShippingOptionNickname; ?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? echo $ShipNotes; ?></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
      <?
