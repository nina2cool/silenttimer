...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	if ($_POST['Add'] == "Add")
	{
		...
		$Type = $_POST['Type'];
		$EbayName = dbQuote($_POST['txtEbayName']);
		...
		mysql_query($sql) or die("Cannot insert purchase2, please try again.");
			...
			*/
			...
			$sql8 = "UPDATE tblPromotionCode SET EndDate = '$PromoEndDate' WHERE PromotionCodeID = '$CustomerID' AND PromotionID = 'percent'";
			//echo $sql8;
			$result8 = mysql_query($sql8) or die("Cannot update promotion code ID");
...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Add
      a new order for <? echo $FirstName; ?> <? echo $LastName; ?></strong></font></p>
  ...
  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
    <tr>
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="CompanyName" type="text" id="FirstName2" value="<? echo $CompanyName; ?>" size="30">
      </font></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      Name </strong></font></td>
      <td><input name="EbayName" type="text" id="EbayName3" value="<? echo $EbayName; ?>" size="30"></td>
    </tr>
  </table>
