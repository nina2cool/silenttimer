...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT * FROM tblCustomerEdit WHERE Type = 'login' AND Status = 'active'AND CustomerID = '$CustomerID'";
...
Log In for <? echo $FirstName; ?> <? echo $LastName; ?></strong></font></p>
<ul>
...
?>
    <tr bgcolor="#FFFFCC"> 
      <td class=sort> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a href="CustomerLoginView2.php?sort=tblCustomerEdit.CustomerID&d=<? if ($sortBy=="tblCustomerEdit.CustomerID") {echo $sd;} else {echo "ASC";}?>">Customer
      ...
      <td class=sort><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="CustomerLoginView2.php?sort=tblCustomerEdit.DateTime&d=<? if ($sortBy=="tblCustomerEdit.DateTime") {echo $sd;} else {echo "ASC";}?>">DateTime</a></font></div></td>
      <?
