...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT DATE_FORMAT(DateTime, '%m/%d/%Y %H:%i:%s') as DateTime, AffiliateID FROM tblCustomerEdit WHERE Type = 'login-partner' AND Status = 'active' AND AffiliateID = '$AffiliateID'";
