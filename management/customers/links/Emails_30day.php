...
<?
	...
	WHERE tblPurchase2.Status = 'active' AND tblPurchase2.OrderDateTime > '2006-01-01' AND tblCustomer.Type <> '6' 
	AND tblCustomer.Type <> '5' AND TestID = '0' OR tblPurchase2.Status = 'active' AND tblPurchase2.OrderDateTime > '2006-01-01' 
	AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '5' AND TestID = '1'";
...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong><? echo number_format($NumTotal); ?> Customers
      to email since January 1, 2006 </strong></font></p>
<form>
