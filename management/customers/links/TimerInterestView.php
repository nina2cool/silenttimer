...
<?
	...
	$sql = "SELECT * FROM tblTimerContacts WHERE type = 'Timer' OR type = 'timer'";
...
?>
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong><? echo number_format($NumTotal); ?> Timer
      Interest Emails </strong></font></p>
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">&gt; <a href="TimerInterestViewPurchase.php">View
