...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT DATE_FORMAT(DateTime, '%m/%d/%Y %H:%i:%s') as DateTime, EmployeeID FROM tblCustomerEdit WHERE Type = 'login - mgt' AND Status = 'active' AND EmployeeID = '$EmployeeID'";
...
Log In for <? echo $FirstName; ?></strong></font></p>
<ul>
...
?>
    <tr bgcolor="#FFFFCC"> 
      ...
      <td width="25%" bgcolor="#FFFFCC" class=sort><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="CustomerLoginViewMgt.php?sort=tblCustomerEdit.DateTime&d=<? if ($sortBy=="tblCustomerEdit.DateTime") {echo $sd;} else {echo "ASC";}?>">DateTime</a></font></div></td>
      <?
