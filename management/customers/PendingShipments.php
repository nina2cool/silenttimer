...
<?
			...
			WHERE 
			tblPurchase2.Preorder = 'n' AND tblPurchase2.Status = 'active' 
			AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '8'
			...
			ON tblPurchase2.ShipCostID = tblShippingCost5.ShipCostID
			WHERE 
			tblPurchase2.Preorder = 'n' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6'  
			AND tblCustomer.Type <> '8' AND tblPurchase2.Status = 'active' AND tblCustomer.CountryID <> '225' 
...
<?
			...
			WHERE tblPurchase2.Preorder = 'n' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '8' 
			AND tblPurchase2.Status = 'active' AND tblCustomer.CountryID <> '225' AND tblCustomer.CountryID <> '241'
			AND tblCustomer.CountryID <> '242' AND tblCustomer.CountryID <> '243' AND tblPurchase2.Shipped = 'p'";
...
<? 
			...
			INNER JOIN tblShippingCost5
			ON tblPurchase2.ShipCostID = tblShippingCost5.ShipCostID
			WHERE tblPurchase2.Preorder = 'n' AND tblPurchase2.Status = 'active' AND tblPurchase2.Shipped = 'p'
...
<?  
			...
			INNER JOIN tblShippingCost5
			ON tblPurchase2.ShipCostID = tblShippingCost5.ShipCostID
			WHERE tblPurchase2.Preorder = 'n' AND tblPurchase2.Status = 'active' AND tblCustomer.Type = '8' AND tblPurchase2.Shipped = 'p'";
