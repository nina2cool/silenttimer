...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	if ($_POST['Add'] == "Add")
	{
		...
		$sql = "INSERT INTO tblPurchase2(CustomerID, TestID, TestDate, ReferredByID, Discount, OrderDateTime, 
			...
			ShipNotes, NovaPress, Preorder, Preordered)
...
<p><font size="2" face="Arial, Helvetica, sans-serif">&gt; <a href="Order_Phone2.php">Process
order and charge their card</a></font></p>
