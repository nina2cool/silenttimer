...
require "../include/dbinfo.php";
 ...
 // -------- code to save values from form into table, etc....
	...
	if ($_POST['Go'] == "Go")
	{
		...
		$ShippedAll = $_POST['ShippedAll'];
		$Multiple = $_POST['Multiple'];
		//$Num = $_POST['Num'];
		
		
		#if All items were shipped and in one box
		if($ShippedAll == 'y' AND $Multiple == '')
		{
			...
			$ProductID = $row9[ProductID];
					...
					$result8 = mysql_query($sql8) or die("Cannot update tblProductNew!");
	...
	elseif($ShippedAll == '' AND $Multiple == '')
			{
					
					//$goto = "NotShippedDetails2.php?cust=$CustomerID&purch=$PurchaseID";
					//header("location: $goto");
					?>
					<meta http-equiv='refresh' content='0;URL=<? echo $http; ?>customers/Shipped_NotAll_Single.php?cust=<? echo $CustomerID; ?>&purch=<? echo $PurchaseID; ?>'>
					<?

			}
			#if not all of the items were shipped and there were multiple boxes
			elseif($ShippedAll == '' AND $Multiple == 'y')
			{
			...
			elseif($ShippedAll == 'y' AND $Multiple == 'y')
			{
						$goto = "Shipped_All_MultipleBoxes.php?cust=$CustomerID&purch=$PurchaseID";
							header("location: $goto");


					/*?>
					<meta http-equiv='refresh' content='0;URL=<? echo $http; ?>customers/Shipped_All_MultipleBoxes.php?cust=<? echo $CustomerID; ?>&purch=<? echo $PurchaseID; ?>'>
					<?*/
		...
		if($SendEmail == 'y')
		{
			...
			require "../../code/class.phpmailer.php";
				...
				if($ShipperID == '6')
				{
					...
					//$mail->AddBCC("siobhan@silenttimer.com", "SilentTimer.com Shipment");
					$mail->IsHTML(true);
				...
				elseif($ShipperID == '8' AND $TrackingNumber <> '')
				{
						...
						<td align='left' valign='top'>
							...
							<tr> 
						      ...
						      $FirstName</em></font><font size='2' face='Arial, Helvetica, sans-serif'>,</font></p>
								<p><font size='3' face='Arial, Helvetica, sans-serif'><strong>Your order
									has been shipped!</strong></font></p>
								<p><a href='http://www.silenttimer.com/customerservice/'><font size='2' face='Arial, Helvetica, sans-serif'>Click to log in and view your order history and account information.</font></a></p>
								<p><font size='2' face='Arial, Helvetica, sans-serif'>Thank you, good 
								    luck studying for your test! </font></p>
								<p><font color='#FF3300' size='2' face='Arial, Helvetica, sans-serif'><font color='#000000'><strong><font color='#FF3300'>Silent 
								  Technology LLC</font></strong></font></font><font color='#FF3300' size='2' face='Arial, Helvetica, sans-serif'></font><font size='2' face='Arial, Helvetica, sans-serif'><br>
...
?>
                ...
                <font color="#000000" size="5" face="Arial, Helvetica, sans-serif"><strong>&gt; Shipment
                Detail:</strong></font><font face="Arial, Helvetica, sans-serif"><strong><font color="#003399" size="5"> <? echo "$FirstName $LastName";?></font><font color="#003399"> 
                <?
...
?>
                (#<? echo $PurchaseID; ?>)</font></strong></font><font color="#003399">
                </p>
</font>			
			  ...
			  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
                <tr bgcolor="#FFFFCC">
                  ...
                  <td><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">ShipCostID <a href="ShipCostID.php" target="_blank">view
                  list</a></font></strong></div></td>
...
<?
				...
				elseif($ShipCostID == '166' OR $ShipCostID == '165')
				{
				$Cost = 6.60;
				}
				elseif($ShipCostID == '933')
				{
				$Cost = 8.00;
				}	
				else
...
?>
                ...
                <tr>
                  ...
                  <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                    <input name="TrackingNumber" type="text" id="TrackingNumber" size="30">
                  </font></div></td>
                  <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">$
...
?>				
			  ...
			  <p><font size="2" face="Arial, Helvetica, sans-serif">Shipped All? 
                        <input name="ShippedAll" type="checkbox" id="ShippedAll" value="y" checked>
</font></p>
			  <p><font size="2" face="Arial, Helvetica, sans-serif">Multiple pieces? 
			    <input name="Multiple" type="checkbox" id="Multiple" value="y">
			  </font> </p>
			  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
                          <tr bgcolor="#FFFFCC">
