...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	if($TodayDay == 1)
	{
			if($TodayMonth == 1 OR $TodayMonth == 5 OR $TodayMonth == 7 OR $TodayMonth == 10 OR $TodayMonth == 12)
			{
				$PreviousDay = 30;
					
					if($TodayMonth == 1) { $PreviousMonth = 12; }
					else  { $PreviousMonth = $TodayMonth - 1;
		...
		$Yesterday = "$PreviousYear-$PreviousMonth-$PreviousDay";
		$Yesterday2 = "$PreviousMonth/$PreviousDay/$PreviousYear";	
...
$sql = "SELECT tblCustomer.FirstName, tblCustomer.LastName, tblCustomer.CustomerID, 
		...
		WHERE tblShipment3.DateTime = '$Yesterday'";
...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>&gt; 
  Tracking #'s for </strong></font><font size="5" face="Arial, Helvetica, sans-serif"><strong><? echo $Yesterday2; ?></strong></font></p>
...
?>
    <tr bgcolor="#CCCCCC"> 
      ...
      <td bgcolor="#FFFFCC" class=sort> <div align="center"><strong><a href="TrackViewYesterday.php?sort=tblShipment3.PurchaseID&d=<? if ($sortBy=="tblShipment3.PurchaseID") {echo $sd;} else {echo "ASC";}?>"><font size="2" face="Arial, Helvetica, sans-serif">pID</font></a></strong></div></td>
      <td bgcolor="#FFFFCC" class=sort> <div align="center"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><a href="TrackViewYesterday.php?sort=tblCustomer.BusinessName&d=<? if ($sortBy=="tblCustomer.BusinessName") {echo $sd;} else {echo "ASC";}?>">Company</a></font></strong></div></td>
      <td bgcolor="#FFFFCC" class=sort> <div align="center"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><a href="TrackViewYesterday.php?sort=tblCustomer.LastName&d=<? if ($sortBy=="tblCustomer.LastName") {echo $sd;} else {echo "ASC";} ?>">      Name</a></font></strong></div></td>
      <td bgcolor="#FFFFCC" class=sort> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a href="TrackViewYesterday.php?sort=tblShipment3.TrackingNumber&d=<? if ($sortBy=="tblShipment3.TrackingNumber") {echo $sd;} else {echo "ASC";}?>">Tracking 
