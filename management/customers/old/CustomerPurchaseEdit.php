    ...
    <tr> 
      <td align="left" valign="top"> <p><font color="#003399" size="3" face="Arial, Helvetica, sans-serif"><strong>&nbsp;&gt; 
        ...
        <p><strong><font color="#003399" size="3" face="Arial, Helvetica, sans-serif">Same? 
          <input name="txtSame" type="text" id="txtSame" value="<? echo addQuote($Same);?>" size="5">
          </font></strong></p>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#003399">
    <tr> 
      <td align="left" valign="top"> <p><font color="#003399" size="3" face="Arial, Helvetica, sans-serif"><strong> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr align="left" valign="top"> 
            <td width="59%"><font size="2" face="Arial, Helvetica, sans-serif"> <strong>Test 
              ID Number</strong><br>
              <input name="txtTestID" type="text" id="txtTestID" value="<? echo $TestID;?>">
              </font></td>
            <td width="41%"><font size="2" face="Arial, Helvetica, sans-serif"><strong>School</strong><br>
          ...
          <tr align="left" valign="top"> 
            <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>Type 
              </strong>(default: web, ebay, bulk, samples, amazon, replacement)<br>
          ...
          <tr align="left" valign="top">
            <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>Replacement 
              Type</strong> <font size="2" face="Arial, Helvetica, sans-serif">(web, 
              ebay, powerscore, bn)</font><br>
              <input name="txtReplacementType" type="text" id="txtReplacementType4" value="<? echo $ReplacementType;?>">
              </font></td>
            <td><font size="2" face="Arial, Helvetica, sans-serif"> <strong>Replacement 
              </strong>(y or n) <br>
              <input name="txtReplacement" type="text" id="txtReplacement" value="<? echo $Replacement;?>">
              </font></td>
          </tr>
          <tr align="left" valign="top"> 
            <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>Purchase 
