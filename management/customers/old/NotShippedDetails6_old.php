...
if($QuantityShipped == $Sum)
{
		...
		foreach ($TrackingNumber as $TrackNum)
		{
		
			echo "<br>Tracking # = " .$TrackNum;
			...
			$TrackingNumberExist = $row11[TrackingNumber];
					...
					if($TrackNum <> $TrackingNumberExist AND $TrackNum <> "")
					{
					...
					'$TrackNum', '$ShipmentCost1', '$ShipCostID', 'y')";
			...
			$sql22 = "SELECT * FROM tblShipment3 WHERE TrackingNumber = '$TrackNum'";
			//put SQL statement into result set for loop through records
...
?>
			...
			<form name="form1" method="post" action="">
			  <p><strong><font size="2" face="Arial, Helvetica, sans-serif">Shipment Date
			        = 
			        <input name="Date" type="text" id="Date" value="<? echo date("Y-m-d");?>" size="8">
			  </font></strong></p>
			  <p><strong><font size="2" face="Arial, Helvetica, sans-serif">ShipCostID
			        <a href="ShipCostID.php" target="_blank">view list</a> =    
			        <input name="ShipCostID2" type="text" id="ShipCostID2" value="<? echo $ShipCostID2; ?>" size="4">
			  </font></strong></p>
