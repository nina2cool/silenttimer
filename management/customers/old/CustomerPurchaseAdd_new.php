...
<form name="form1" method="post" action="">
  ...
  <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
    ...
    <tr>
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>
        <input name="NovaPress" type="text" id="PONumber2" value="n" size="3" maxlength="1">
      </strong></font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Purchase
  ...
  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
    ...
    <tr>
      <td><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"><strong>Address
            Verification<br>
      </strong>AVS Match 5 Digit Zip and Address (Y)</font></td>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">        <select name="AddressVerification" id="AddressVerification">
    ...
    <tr>
      ...
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">        <select name="CVV2Verification" id="CVV2Verification">
          <option selected>n/a</option>
