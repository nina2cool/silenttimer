...
<?
			...
			WHERE tblPurchase2.Status = 'active' AND tblPurchaseDetails2.Status = 'active' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '8'
			...
			AND tblPurchaseDetails2.Shipped = 'n' AND tblPurchaseDetails2.Status = 'active'";
...
<? 
			...
			AND tblCustomer.Type = '6' AND tblPurchaseDetails2.Shipped = 'n' AND tblPurchaseDetails2.Status = 'active'";
...
<?  
			...
			INNER JOIN tblPurchaseDetails2
			ON tblPurchase2.PurchaseID = tblPurchaseDetails2.PurchaseID
			WHERE tblPurchase2.Status = 'active' AND tblCustomer.Type = '5' AND tblPurchaseDetails2.Shipped = 'n' AND tblPurchaseDetails2.Status = 'active' OR
			tblPurchase2.Status = 'active' AND tblCustomer.Type = '8' AND tblPurchaseDetails2.Shipped = 'n' AND tblPurchaseDetails2.Status = 'active'";
