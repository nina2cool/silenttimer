...
<form name="form" method="post" action="SearchResults.php?sort=tblPurchase.DateTime&d=DESC">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="10">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr> 
            <td width="10%" rowspan="2" align="center" valign="middle"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
              <input type="radio" name="radioSelection" value="ebayname">
              </font></strong></td>
            <td width="41%"><strong><font size="2" face="Arial, Helvetica, sans-serif">eBay/Amazon 
              Name </font></strong></td>
            <td width="7%" rowspan="2"><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                <input type="radio" name="radioSelection" value="ebayitemnumber">
                </font></strong></div></td>
            <td width="42%"><strong><font size="2" face="Arial, Helvetica, sans-serif">Item 
              # </font></strong></td>
          </tr>
          <tr> 
            <td><input name="txtEbayName" type="text" id="txtEbayName" size="20"></td>
            <td><input name="txtEbayItemNumber" type="text" id="txtEbayItemNumber" size="20"></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
