...
<?
			...
			WHERE tblPurchase2.Preorder = 'n' AND tblPurchase2.Status = 'active' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '8'
			AND tblPurchase2.Shipped = 'n' OR tblPurchase2.Preorder = 'n' AND tblPurchase2.Status = 'active' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '8'
...
?>
  <tr bgcolor="#CCCCFF">
    ...
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblPurchase2.PurchaseID&d=<? if ($sortBy=="tblPurchase2.PurchaseID") {echo $sd;} else {echo "ASC";}?>">pID</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.LastName&d=<? if ($sortBy=="tblCustomer.LastName") {echo $sd;} else {echo "ASC";}?>">Name</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.City&d=<? if ($sortBy=="tblCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.State&d=<? if ($sortBy=="tblCustomer.State") {echo $sd;} else {echo "ASC";}?>">St.</a></strong></font></div></td>
    <td bgcolor="#CCCCFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.ZipCode&d=<? if ($sortBy=="tblCustomer.ZipCode") {echo $sd;} else {echo "ASC";}?>">Zip</a></strong></font></div></td>
    <td bgcolor="#CCCCFF"><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> <a href="NotShippedView4.php?sort=tblShippingCost5.ShippingOptionID&d=<? if ($sortBy=="tblShippingCost5.ShippingOptionID") {echo $sd;} else {echo "ASC";}?>">Code</a>/<a href="NotShippedView4.php?sort=tblShippingCost5.ShipperID&d=<? if ($sortBy=="tblShippingCost5.ShipperID") {echo $sd;} else {echo "ASC";}?>">Shipper</a></strong></font></div></td>
...
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  ...
  <tr bgcolor="#FFFFCC">
    ...
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong>Cust</strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblPurchase2.PurchaseID&d=<? if ($sortBy=="tblPurchase2.PurchaseID") {echo $sd;} else {echo "ASC";}?>">pID</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.BusinessName&d=<? if ($sortBy=="tblCustomer.BusinessName") {echo $sd;} else {echo "ASC";}?>">Company</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.LastName&d=<? if ($sortBy=="tblCustomer.LastName") {echo $sd;} else {echo "ASC";}?>">Name</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.City&d=<? if ($sortBy=="tblCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.State&d=<? if ($sortBy=="tblCustomer.State") {echo $sd;} else {echo "ASC";}?>">St.</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="NotShippedView4.php?sort=tblCustomer.ZipCode&d=<? if ($sortBy=="tblCustomer.ZipCode") {echo $sd;} else {echo "ASC";}?>">Zip</a></strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> <a href="NotShippedView4.php?sort=tblCustomer.Country&d=<? if ($sortBy=="tblCustomer.Country") {echo $sd;} else {echo "ASC";}?>">Country</a></strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> <a href="NotShippedView4.php?sort=tblShippingCost5.ShippingOptionID&d=<? if ($sortBy=="tblShippingCost5.ShippingOptionID") {echo $sd;} else {echo "ASC";}?>">Code</a>/<a href="NotShippedView4.php?sort=tblShippingCost5.ShipperID&d=<? if ($sortBy=="tblShippingCost5.ShipperID") {echo $sd;} else {echo "ASC";}?>">Shipper</a></strong></font></div></td>
