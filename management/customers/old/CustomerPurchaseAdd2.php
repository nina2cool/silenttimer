...
<form name="form1" method="post" action="">
  ...
  <p><font color="#000033" size="2" face="Arial, Helvetica, sans-serif">
    <select name="CustomerID" class="text">
      ...
      <?  
						...
						{
					?>
      <option value= "<? echo $row[CustomerID];?>"><? echo $row[BusinessName];?>: <? echo $row[FirstName];?> <? echo $row[LastName];?></option>
      <?
						}
					?>
    </select>
  ...
  <p><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"> &gt;&gt;If
        this is a new customer, <a href="<? echo $http; ?>customers/CustomerPurchaseAdd.php">click
        here</a>.</font></p>
