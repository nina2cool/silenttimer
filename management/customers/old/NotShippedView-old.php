...
<? 
			...
			FROM tblCustomer INNER JOIN tblPurchase2
			ON tblCustomer.CustomerID = tblPurchase2.CustomerID
			RIGHT JOIN tblPurchaseDetails2 ON tblPurchase2.PurchaseID = tblPurchaseDetails2.PurchaseID
			WHERE tblPurchase2.Status = 'active'
			AND tblCustomer.Type = '6' AND tblPurchase2.Shipped = 'n' AND tblPurchaseDetails2.Status = 'active'";
