...
<?	
	...
	if ($_POST['Add'] == "Add")
	{
		...
		'$ShippingCost', '$PurchaseNotes', '$ShipNotes', 'y', '$Status');"; 
		...
		VALUES('$CustomerID', '$Tax', '$Subtotal', '$Discount', '$Paid', '$PaymentTerms', 
		'$PONumber', '$InvoiceNumber', '$InvoiceDate', '$NovaPress', '$OrderDateTime', '$Shipped', '$ShipCostID', 
...
<td><font size="2" face="Arial, Helvetica, sans-serif">
  ...
  <p><strong><font color="#003399" size="3" face="Arial, Helvetica, sans-serif">&gt; Invoicing
  Information</font></strong></p>
  <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">DiscountRate</font></strong><font size="2" face="Arial, Helvetica, sans-serif"> (as
          a decimal percent: 0.40) </font></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="DiscountRate" type="text" id="DiscountRate">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Do we pay for shipping?
          </font></strong><font size="2" face="Arial, Helvetica, sans-serif">(y/n)</font></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="WePayShip" type="text" id="WePayShip" value="n" size="5" maxlength="1">
      </font></td>
    </tr>
    <tr>
      ...
      <td><select name="Terms" id="Terms">
          ...
          <option value="pay to Nova Press">pay to Nova Press</option>
      </select></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Contact 1 </font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="Contact1" type="text" id="Contact1">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Contact 2 </font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="Contact2" type="text" id="Contact2">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">NameB</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="NameB" type="text" id="NameB">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">AttentionTo</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="AttentionTo" type="text" id="AttentionTo">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">AddressB</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="AddressB" type="text" id="AddressB">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Address2B</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="Address2B" type="text" id="Address2B">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">CityB</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="CityB" type="text" id="CityB">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">StateB</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
    ...
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">StateOtherB</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="StateOtherB" type="text" id="StateOtherB">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">ZipCodeB</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="ZipCodeB" type="text" id="ZipCodeB">
      </font></td>
    </tr>
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">CountryBID</font></strong></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <select name="CountryBID" tabindex="" id="CountryBID" class="text">
          <option value="" selected>Select</option>
          <? 
					$sql3 = "SELECT * FROM tblShipLocation ORDER BY Name";
					$result3 = mysql_query($sql3) or die("Cannot get CountryB");
    ...
    <tr>
      <td><strong><font size="2" face="Arial, Helvetica, sans-serif">Same Invoicing Address?
          </font></strong><font size="2" face="Arial, Helvetica, sans-serif">(y/n)</font></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <input name="Same" type="text" id="Same" value="y" size="5" maxlength="1">
      </font></td>
    </tr>
    <tr>
