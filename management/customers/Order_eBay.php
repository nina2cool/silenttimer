...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	if ($_POST['Add'] == "Add")
	{
		...
		if($Receipt == 'y')
		{
		mail("$Email, ebay@silenttimer.com", "eBay Purchase Item # $EbayItemNumber1", "Silent Timer eBay Item #$EbayItemNumber1\n\n$FirstName, thank you for your purchase!\n\nYour order will be shipped by the next business day. You will receive an email from USPS with your tracking number. Download The Silent Timer Time Management Guide at http://www.silenttimer.com/order/guide/ST_TimeManGuide_061405.pdf to help you with your pacing. You may also log in and view your order history on our web site.\n\nIf you have any other questions, please email us at ebay@silenttimer.com. We will be glad to help you!\n\nThanks!\nChristina, The Silent Timer eBay Team\n1-800-552-0325\nwww.SilentTimer.com", "From:The Silent Timer eBay Team<ebay@silenttimer.com>");
		}
