...
<?
	...
	$result9 = mysql_query($sql9) or die("Cannot retrieve company info, please try again.");
		...
		while($row9 = mysql_fetch_array($result9))
			...
			AND tblPurchase2.Shipped = 'n' AND tblPurchaseDetails2.Status = 'active' AND tblShippingCost5.ShippingOptionID = '$ShippingOptionID'
			GROUP BY tblPurchase2.PurchaseID
			ORDER BY tblPurchase2.PurchaseID
			";
			//echo $sql55;
	...
	CardType, LastFourCr, ZipB, PromotionCodeID, IsCheck, PONumber, InvoiceNumber
