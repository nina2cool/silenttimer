...
if ($_POST['Go'] == "Go")
	{
		...
		$goto = "Shipped_All_MultipleBoxes3.php?cust=$CustomerID&purch=$PurchaseID";
...
?>
                ...
                <p><font color="#000000" size="5" face="Arial, Helvetica, sans-serif"><strong>&gt; Shipment
...
<form name="form1" method="post" action="">
			  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
                <tr bgcolor="#FFFFCC">
                  ...
                  <td><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">Num
