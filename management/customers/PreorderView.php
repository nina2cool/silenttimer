...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td><font color="#003399" size="2" face="Arial, Helvetica, sans-serif">&gt; <a href="PreorderChargeList.php"><strong>Preorder
    Charge List</strong></a></font></td>
  </tr>
  <tr>
    <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>&gt; <a href="PreorderEmail.php">Send
          email notifying of impending shipment and verifying shipping info</a> </strong>-
          use when ready to notify customers ONLY </font></td>
  </tr>
</table>
...
<?
			...
			WHERE tblPurchase2.Preorder = 'y' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6'  AND tblCustomer.Type <> '8' AND tblPurchase2.Status = 'active' AND tblCustomer.CountryID <> '225' AND tblCustomer.CountryID <> '241'
			AND tblCustomer.CountryID <> '242' AND tblCustomer.CountryID <> '243' AND tblPurchase2.Shipped = 'n' OR tblPurchase2.Preorder = 'y' AND tblCustomer.Type <> '5' AND tblCustomer.Type <> '6'  AND tblCustomer.Type <> '8' AND tblPurchase2.Status = 'active' AND tblCustomer.CountryID <> '225' AND tblCustomer.CountryID <> '241'
...
?>
  <tr bgcolor="#CCCCFF">
    ...
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblPurchase2.PurchaseID&d=<? if ($sortBy=="tblPurchase2.PurchaseID") {echo $sd;} else {echo "ASC";}?>">pID</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.LastName&d=<? if ($sortBy=="tblCustomer.LastName") {echo $sd;} else {echo "ASC";}?>">Name</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.City&d=<? if ($sortBy=="tblCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.State&d=<? if ($sortBy=="tblCustomer.State") {echo $sd;} else {echo "ASC";}?>">St.</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.ZipCode&d=<? if ($sortBy=="tblCustomer.ZipCode") {echo $sd;} else {echo "ASC";}?>">Zip</a></strong></font></div></td>
...
if($CountryID == '225' OR $CountryID == '241' OR $CountryID == '242' OR $CountryID == '243')
{
  ...
  <tr>
	...
	<td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
		...
		<?
			$sql5 = "SELECT * FROM tblPurchaseDetails2 WHERE PurchaseID = '$PurchaseID' AND Status = 'preorder' AND Shipped = 'n'";
...
?>
<p> <font size="2" face="Arial, Helvetica, sans-serif"><?php echo $RegInt; ?> Customers (International)</font></p>
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  <tr bgcolor="#FFFFCC">
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong>Ship</strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong>Cust</strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblPurchase2.PurchaseID&d=<? if ($sortBy=="tblPurchase2.PurchaseID") {echo $sd;} else {echo "ASC";}?>">pID</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.BusinessName&d=<? if ($sortBy=="tblCustomer.BusinessName") {echo $sd;} else {echo "ASC";}?>">Company</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.LastName&d=<? if ($sortBy=="tblCustomer.LastName") {echo $sd;} else {echo "ASC";}?>">Name</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.City&d=<? if ($sortBy=="tblCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.State&d=<? if ($sortBy=="tblCustomer.State") {echo $sd;} else {echo "ASC";}?>">St.</a></strong></font></div></td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong><a href="PreorderView.php?sort=tblCustomer.ZipCode&d=<? if ($sortBy=="tblCustomer.ZipCode") {echo $sd;} else {echo "ASC";}?>">Zip</a></strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong> <a href="PreorderView.php?sort=tblCustomer.Country&d=<? if ($sortBy=="tblCustomer.Country") {echo $sd;} else {echo "ASC";}?>">Country</a></strong></font></div></td>
...
<? 
			...
			WHERE tblPurchase2.Preorder = 'y' AND tblPurchase2.Status = 'active' AND tblPurchase2.Shipped = 'n'
			AND tblCustomer.Type = '6' OR tblPurchase2.Preorder = 'y' AND tblPurchase2.Status = 'active' AND tblPurchase2.Shipped = 'p'
...
<p><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $Bulk; ?> Bulk Customers </font></p>
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  <tr bgcolor="#C7F1C7">
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong>Ship</strong></font></div></td>
    <td><div align="center"><font color="#003399" size="1" face="Arial, Helvetica, sans-serif"><strong>Cust</strong></font></div></td>
    ...
    <?
			  ...
			  ?>
  <tr>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="PreorderConvert.php?purch=<? echo $PurchaseID; ?>&cust=<? echo $CustomerID; ?>">Convert
...
<?  
			...
			FROM tblCustomer INNER JOIN tblPurchase2
			ON tblCustomer.CustomerID = tblPurchase2.CustomerID
			WHERE tblPurchase2.Preorder = 'y' AND tblPurchase2.Status = 'active' AND tblCustomer.Type = '5' AND tblPurchase2.Shipped = 'n' OR
			tblPurchase2.Preorder = 'y' AND tblPurchase2.Status = 'active' AND tblCustomer.Type = '8' AND tblPurchase2.Shipped = 'p'";
