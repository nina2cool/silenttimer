...
<?
	...
	$sql3 = "SELECT Sum(Hours) as Sum
	from tblTime WHERE EmployeeID = '$EmployeeID' AND Paid = 'n' AND Status = 'active' GROUP BY EmployeeID
	ORDER BY Date DESC";
	...
	$sql = "SELECT * from tblTime WHERE EmployeeID = '$EmployeeID' AND Paid = 'n' AND Status = 'active' ORDER BY Date";
...
<p>&nbsp;</p>
<p><font size="2" face="Arial, Helvetica, sans-serif">Tell <a href="mailto:nina@silenttimer.com">Christina</a>  if you made a mistake on your timesheet.</font></p>
<p> 
  <?
