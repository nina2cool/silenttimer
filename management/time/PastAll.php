...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT Sum(Hours) as Sum, CheckNumber, DatePaid, EmployeeID from tblTime 
	WHERE Paid = 'y' AND Status = 'active' GROUP BY EmployeeID, DatePaid ORDER BY CheckNumber DESC";
  ...
  <?
 	// this code loops through the returned recordset and saves the different fields into these variable, then prints it all out in a nice table format
				...
				$EmployeeID2 = $row[EmployeeID];
						...
						$sql4 = "SELECT * FROM tblEmployee WHERE EmployeeID = '$EmployeeID2'";
