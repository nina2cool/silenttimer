...
<?
	...
	$sql = "SELECT tblPurchase.PurchaseID, tblPurchase.CustomerID, tblCustomer.LastName, tblCustomer.FirstName, tblCustomer.Type, tblProduct.ProductName, tblPurchase.NumOrdered, tblCustomer.City, tblCustomer.State, tblCustomer.ZipCode, tblCustomer.Country, tblCustomer.Type,
...
?>
			...
			<p><font size="5" face="Arial, Helvetica, sans-serif"><strong>&gt; Purchases</strong></font></p>
...
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  ...
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="5%" class=sort> <div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="viewpurchases.php?sort=tblPurchase.PurchaseID&d=<? if ($sortBy=="tblPurchase.PurchaseID") {echo $sd;} else {echo "ASC";}?>
				">pID</a></font></strong></font></div></td>
    <td width="10%" class=sort><div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="viewpurchases.php?sort=tblCustomer.FirstName&d=<? if ($sortBy=="tblCustomer.FirstName") {echo $sd;} else {echo "ASC";} ?>">First 
        Name</a></font></strong></font></div></td>
    <td width="10%" class=sort> <div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="viewpurchases.php?sort=tblCustomer.LastName&d=<? if ($sortBy=="tblCustomer.LastName") {echo $sd;} else {echo "ASC";} ?>">Last 
        Name</a></font></strong></font></div></td>
    ...
    <td width="11%" class=sort><div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>Country</strong></font></div></td>
    <td width="9%" class=sort> <div align="center"><font color="#003399" face="Arial, Helvetica, sans-serif"><strong><font size="2"><a href="viewpurchases.php?sort=tblPurchase.NumOrdered&d=<? if ($sortBy=="tblPurchase.NumOrdered") {echo $sd;} else {echo "ASC";} ?>"># 
        Ordered</a></font></strong></font></div></td>
    <td width="7%" class=sort> <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="viewpurchases.php?sort=tblPurchase.TotalCost&d=<? if ($sortBy=="tblPurchase.TotalCost") {echo $sd;} else {echo "ASC";} ?>">Total</a></strong></font></div></td>
    <td width="11%" class=sort> <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="viewpurchases.php?sort=tblPurchase.DateTime&d=<? if ($sortBy=="tblPurchase.DateTime") {echo $sd;} else {echo "ASC";} ?>">Date 
        Time </a></strong></font></div></td>
    <td width="15%" class=sort><div align="center"><a href="viewpurchases.php?sort=tblCustomer.Type&d=<? if ($sortBy=="tblCustomer.Type") {echo $sd;} else {echo "ASC";} ?>"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Type</strong></font></a></div></td>
  </tr>
  <?
			  ...
			  ?>
  <tr> 
    <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="editpurchases.php?p=<? echo $pID; ?>&c=<? echo $cID; ?>"><strong>Details</strong></a></font></div></td>
    ...
    <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $country; ?></strong></font></td>
