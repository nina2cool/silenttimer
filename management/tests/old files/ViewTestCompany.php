...
$sql = "Select * FROM tblTestCompany";
/*	
//beginning SQL statement that gets all data from tables.
	$sql = "SELECT tblPurchase.PurchaseID, tblPurchase.CustomerID, tblCustomer.ContactPerson, 
...
// Add Where stmt to SQL to sort by Last Name
	if ($radio == "ContactPerson")
	{
		$sql .= " WHERE tblTestCompany.ContactPerson = '$ContactPerson'";
	}

// Add Where stmt to SQL to sort by First Name
	if ($radio == "CompanyName")
	{
		$sql .= " WHERE tblTestCompany.CompanyName = '$CompanyName'";
	}
...
?>
			...
			<font size="5" face="Arial, Helvetica, sans-serif"><strong>&gt; 
             Test Companies</strong></font></p>
            
			<form>
			
  <table width="50%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
    <?
...
?>
    <tr bgcolor="#CCCCCC"> 
      ...
      <td width="84" class=sort> <div align="center"><font color="#003399"><strong><font size="2" 
				     face="Arial, Helvetica, sans-serif"><a href="../tests/ViewTestCompany.php?sort=tblTestCompany.CompanyName&d=<? if ($sortBy=="tblTestCompany.CompanyName") {echo $sd;} else {echo "ASC";}?>">Company 
          Name</a></font></strong></font></div></td>
      <td width="75" class=sort> <div align="center"><font color="#003399"><strong><font size="2" 
				      face="Arial, Helvetica, sans-serif"><a href="../tests/ViewTestCompany.php?sort=tblTestCompany.ContactPerson&d=<? if ($sortBy=="tblTestCompany.ContactPerson") {echo $sd;} else {echo "ASC";} ?>">Contact 
          Person</a></font></strong></font></div></td>
      ...
      <?
				...
				{ 
				$testID = $row[TestCompanyID]; //autonumer for each Shipper
    ...
    <tr> 
      ...
      <td width="64"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="editTestCompany.php?test=<? echo $testID; ?>"><strong>Details</strong></a></font></div></td>
      <!--	<td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $pID; ?></strong></font></div></td> -->
      <td width="84"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $CompanyName; ?></strong></font></div></td>
      <td width="75"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $ContactPerson; ?></strong></font></div></td>
