...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "Select * FROM tblLinks WHERE Status = 'active' AND Type = '$Type'";
...
?>
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong><? echo $Type; ?> Links</strong></font></p>


  
 <p><font size="2" face="Arial, Helvetica, sans-serif">Choose a test: </font></p>
<ul><?
	$sql2 = "SELECT * FROM tblLinks WHERE Type = '$Type' GROUP BY Test";
...
?>
      ...
      <li><font size="2" face="Arial, Helvetica, sans-serif"><a href="LinkViewType.php?type=<? echo $Type; ?>&test=<? echo $Test; ?>"><? echo $Test; ?></a></font></li>
