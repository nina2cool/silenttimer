...
// Add Where stmt to SQL to sort by First Name
	if ($radio == "FirstName")
	{
		$sql .= " WHERE tblCustomsAgent.FirstName = '$FirstName'";
	}
...
?>
			  <tr bgcolor="#CCCCCC"> 
                ...
                <td width="6%" class=sort> <div align="center"><font color="#003399"><strong><font size="2" 
				     face="Arial, Helvetica, sans-serif"><a href="CustomsAgent.php?sort=tblCustomsAgent.FirstName&d=<? if ($sortBy=="tblCustomsAgent.FirstName") {echo $sd;} else {echo "ASC";}?>">First
					  Name</a></font></strong></font></div></td>
        
		    <td width="17%" class=sort> <div align="left"><font color="#003399"><strong><font size="2" 
				      face="Arial, Helvetica, sans-serif"><a href="CustomsAgent.php?sort=tblCustomsAgent.LastName&d=<? if ($sortBy=="tblCustomsAgent.LastName") {echo $sd;} else {echo "ASC";} ?>">Last 
                      Name</a></font></strong></font></div></td>
...
<td width="43"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="editCustomsAgent.php?ca=<? echo $caID; ?>"><strong>Details</strong></a></font></div></td>
