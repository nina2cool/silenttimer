...
?>
			  <tr bgcolor="#CCCCCC"> 
                ...
                <td width="6%" class=sort> <div align="center"><font color="#003399"><strong><font size="2" 
				     face="Arial, Helvetica, sans-serif"><a href="ViewTestCompany.php?sort=tblTestCompany.CompanyName&d=<? if ($sortBy=="tblTestCompany.CompanyName") {echo $sd;} else {echo "ASC";}?>">Company
					  Name</a></font></strong></font></div></td>
        
		    <td width="17%" class=sort> <div align="left"><font color="#003399"><strong><font size="2" 
				      face="Arial, Helvetica, sans-serif"><a href="ViewTestCompany.php?sort=tblTestCompany.ContactPerson&d=<? if ($sortBy=="tblTestCompany.ContactPerson") {echo $sd;} else {echo "ASC";} ?>">Contact 
...
<td width="43"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="management/shipping_customs/editShipper.php?ship=<? echo $testID; ?>"><strong>Details</strong></a></font></div></td>
				<!--	<td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $pID; ?></strong></font></div></td> -->
					<td width="93"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $CompanyName; ?></strong></font></div></td>
					<td width="95"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $ContactPerson; ?></strong></font></div></td>
