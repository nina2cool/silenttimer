...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
?> <font size="5" face="Arial, Helvetica, sans-serif"><strong>&gt; Warranty Reports 
</strong></font> 
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr> 
                          <td width="10%" rowspan="2" align="center" valign="middle"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
                            <input type="checkbox" name="chkProblem" value="problem">
                            </font></strong></td>
                          
            <td width="205"><strong><font size="2" face="Arial, Helvetica, sans-serif">Problem</font></strong></td>
                        </tr>
                        <tr> 
                          <td>
						   <select name="cboProblem" id="cboProblem2">
						   <?    
								...
								$sql4 = "SELECT DISTINCT ProblemDetails, CustRequest FROM tblProblems";
								//put SQL statement into result set for loop through records
								$result4 = mysql_query($sql4) or die("Cannot execute query4!");
								
								while($row = mysql_fetch_array($result4))
								{

						  	?>
                                  <option value="<? echo $row[ProblemDetails]; ?>" <? if ($row[ProblemDetails] == $ProblemDetails) {echo "selected";} ?>><? echo $row[ProblemDetails]; ?></option>
                             <?
							 	}
								mysql_close($link);
							?>
