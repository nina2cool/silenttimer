...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Test
	...
	$sql = "SELECT Count(PrepClass) as Count, PrepClass FROM tblCustomer WHERE Type = '1' OR Type = '2' GROUP BY PrepClass ORDER BY Count DESC, PrepClass";
	...
	//echo "total = " .$Total;
	$sql4 = "SELECT * FROM tblCustomer WHERE PrepClass <> '' AND Type = '1' OR PrepClass <> '' AND Type = '2'";
...
?>
    <tr bgcolor="#FFFFCC">
      <td class=sort><div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>Test
              Prep Company </strong></font></div></td>
	...
	?>
    <tr>
      <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $PrepClass; ?></font></div></td>
