...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>#
  of People Purchased by City</strong></font>
  <?

	$sql = "SELECT Count(City) as Count, City, State FROM tblCustomer WHERE Type <> '5' AND Type <> '6' GROUP BY City ORDER BY Count DESC, City ASC";
...
?>
    <tr bgcolor="#FFFFCC"> 
      <td width="130" class=sort> <div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong>City</strong></font></div></td>
	...
	?>
    <tr> 
      <td width="130"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $City; ?>, <? echo $State; ?></font></div></td>
