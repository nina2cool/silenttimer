...
<?
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2003-08-31 23:59:59' AND DateTime < '2003-10-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2003-09-30 23:59:59' AND DateTime < '2003-11-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2003-10-31 23:59:59' AND DateTime < '2003-12-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2003-11-30 23:59:59' AND DateTime < '2004-01-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2003-12-31 23:59:59' AND DateTime < '2004-02-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-01-31 23:59:59' AND DateTime < '2004-03-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-02-29 23:59:59' AND DateTime < '2004-04-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-03-31 23:59:59' AND DateTime < '2004-05-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-04-30 23:59:59' AND DateTime < '2004-06-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-05-31 23:59:59' AND DateTime < '2004-07-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-06-30 23:59:59' AND DateTime < '2004-08-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-07-31 23:59:59' AND DateTime < '2004-09-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-08-31 23:59:59' AND DateTime < '2004-10-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-09-30 23:59:59' AND DateTime < '2004-11-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-10-31 23:59:59' AND DateTime < '2004-12-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-30 23:59:59' AND DateTime < '2005-01-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-31 23:59:59' AND DateTime < '2005-02-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-01-31 23:59:59' AND DateTime < '2005-03-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-02-28 23:59:59' AND DateTime < '2005-04-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-03-31 23:59:59' AND DateTime < '2005-05-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-04-30 23:59:59' AND DateTime < '2005-06-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-31 23:59:59' AND DateTime < '2005-07-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-06-30 23:59:59' AND DateTime < '2005-08-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-07-31 23:59:59' AND DateTime < '2005-09-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-08-31 23:59:59' AND DateTime < '2005-10-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-09-30 23:59:59' AND DateTime < '2005-11-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-10-31 23:59:59' AND DateTime < '2005-12-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-11-30 23:59:59' AND DateTime < '2006-01-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Monthly 
  Sales </strong></font></p>
<p><font size="3" face="Arial, Helvetica, sans-serif"><strong>Timers Sold Total</strong></font></p>
...
<table width="75%"  border="0" cellspacing="0" cellpadding="5">
  <tr valign="top">
    <td><ul>
      <li><a href="AugSales2004.php"><font size="2" face="Arial, Helvetica, sans-serif">August
 ...
 ?></font></font></strong></font></li>
      <li><a href="SeptSales2004.php"><font size="2" face="Arial, Helvetica, sans-serif">September
 ...
 ?></font></font></strong></font></li>
      <li><a href="OctSales2004.php"><font size="2" face="Arial, Helvetica, sans-serif">October
 ...
 ?></font></font></strong></font></strong></li>
      <li><a href="NovSales2004.php"><font size="2" face="Arial, Helvetica, sans-serif">November
 ...
 ?></font></font></strong></font></strong></li>
      <li><a href="DecSales2004.php"><font size="2" face="Arial, Helvetica, sans-serif">December
 ...
 ?></font></font></strong></font></strong></li>
    ...
    <td><ul>
      <li><a href="JanSales2005.php"><font size="2" face="Arial, Helvetica, sans-serif">January
            2005:</font></a><strong> <font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Arial, Helvetica, sans-serif"><font color="#FF0000" size="3"><? echo $Jan2005;
 ?></font></font></strong></font></strong></li>
      <li><a href="FebSales2005.php"><font size="2" face="Arial, Helvetica, sans-serif">February
 ...
 ?></font></font></strong></font></strong></li>
      <li><a href="MarSales2005.php"><font size="2" face="Arial, Helvetica, sans-serif">March
 ...
 ?></font></font></strong></font></strong></li>
      <li><a href="AprilSales2005.php"><font size="2" face="Arial, Helvetica, sans-serif">April
...
<?
	...
	$sql = "SELECT Sum(tblPurchase.NumOrdered) AS Sum, tblCustomer.Type
	FROM tblCustomer
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2003-08-31 23:59:59' AND DateTime < '2003-10-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2003-09-30 23:59:59' AND DateTime < '2003-11-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2003-10-31 23:59:59' AND DateTime < '2003-12-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2003-11-30 23:59:59' AND DateTime < '2004-01-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2003-12-31 23:59:59' AND DateTime < '2004-02-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-01-31 23:59:59' AND DateTime < '2004-03-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-02-29 23:59:59' AND DateTime < '2004-04-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-03-31 23:59:59' AND DateTime < '2004-05-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-04-30 23:59:59' AND DateTime < '2004-06-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-05-31 23:59:59' AND DateTime < '2004-07-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-06-30 23:59:59' AND DateTime < '2004-08-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-07-31 23:59:59' AND DateTime < '2004-09-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-08-31 23:59:59' AND DateTime < '2004-10-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-09-30 23:59:59' AND DateTime < '2004-11-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-10-31 23:59:59' AND DateTime < '2004-12-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-11-30 23:59:59' AND DateTime < '2005-01-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2004-12-31 23:59:59' AND DateTime < '2005-02-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-01-31 23:59:59' AND DateTime < '2005-03-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-02-28 23:59:59' AND DateTime < '2005-04-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-03-31 23:59:59' AND DateTime < '2005-05-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-04-30 23:59:59' AND DateTime < '2005-06-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-05-31 23:59:59' AND DateTime < '2005-07-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-06-30 23:59:59' AND DateTime < '2005-08-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-07-31 23:59:59' AND DateTime < '2005-09-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-08-31 23:59:59' AND DateTime < '2005-10-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-09-30 23:59:59' AND DateTime < '2005-11-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-10-31 23:59:59' AND DateTime < '2005-12-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblPurchase
	ON tblPurchase.CustomerID = tblCustomer.CustomerID
	WHERE Type = 'bulk' AND DateTime > '2005-11-30 23:59:59' AND DateTime < '2006-01-01 00:00:00' AND Status = 'active' AND ReferredBy <> '0' AND ReferredBy <> ''
	GROUP BY Type";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
...
?><br>
<font size="3" face="Arial, Helvetica, sans-serif"><strong>Timers Sold to Web/eBay/Amazon/Samples
 Customers</strong></font>
<table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000066">
  <tr> 
