...
- December 2004</strong></font> 
<form>
  <?

	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-30 23:59:59' AND DateTime < '2004-12-02 00:00:00' AND Status = 'active'";
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-01 23:59:59' AND DateTime < '2004-12-03 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-02 23:59:59' AND DateTime < '2004-12-04 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-03 23:59:59' AND DateTime < '2004-12-05 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-04 23:59:59' AND DateTime < '2004-12-06 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-05 23:59:59' AND DateTime < '2004-12-07 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-06 23:59:59' AND DateTime < '2004-12-08 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-07 23:59:59' AND DateTime < '2004-12-09 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-08 23:59:59' AND DateTime < '2004-12-10 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-09 23:59:59' AND DateTime < '2004-12-11 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-10 23:59:59' AND DateTime < '2004-12-12 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-11 23:59:59' AND DateTime < '2004-12-13 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-12 23:59:59' AND DateTime < '2004-12-14 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-13 23:59:59' AND DateTime < '2004-12-15 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-14 23:59:59' AND DateTime < '2004-12-16 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-15 23:59:59' AND DateTime < '2004-12-17 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-16 23:59:59' AND DateTime < '2004-12-18 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-17 23:59:59' AND DateTime < '2004-12-19 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-18 23:59:59' AND DateTime < '2004-12-20 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-19 23:59:59' AND DateTime < '2004-12-21 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-20 23:59:59' AND DateTime < '2004-12-22 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-21 23:59:59' AND DateTime < '2004-12-23 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-22 23:59:59' AND DateTime < '2004-12-24 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-23 23:59:59' AND DateTime < '2004-12-25 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-24 23:59:59' AND DateTime < '2004-12-26 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-25 23:59:59' AND DateTime < '2004-12-27 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-26 23:59:59' AND DateTime < '2004-12-28 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-27 23:59:59' AND DateTime < '2004-12-29 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-28 23:59:59' AND DateTime < '2004-12-30 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-29 23:59:59' AND DateTime < '2004-12-31 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-12-30 23:59:59' AND DateTime < '2005-01-01 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
