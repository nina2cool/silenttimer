...
- November 2004</strong></font> 
<form>
  <?

	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-10-31 23:59:59' AND DateTime < '2004-11-02 00:00:00' AND Status = 'active'";
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-01 23:59:59' AND DateTime < '2004-11-03 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-02 23:59:59' AND DateTime < '2004-11-04 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-03 23:59:59' AND DateTime < '2004-11-05 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-04 23:59:59' AND DateTime < '2004-11-06 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-05 23:59:59' AND DateTime < '2004-11-07 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-06 23:59:59' AND DateTime < '2004-11-08 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-07 23:59:59' AND DateTime < '2004-11-09 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-08 23:59:59' AND DateTime < '2004-11-10 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-09 23:59:59' AND DateTime < '2004-11-11 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-10 23:59:59' AND DateTime < '2004-11-12 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-11 23:59:59' AND DateTime < '2004-11-13 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-12 23:59:59' AND DateTime < '2004-11-14 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-13 23:59:59' AND DateTime < '2004-11-15 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-14 23:59:59' AND DateTime < '2004-11-16 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-15 23:59:59' AND DateTime < '2004-11-17 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-16 23:59:59' AND DateTime < '2004-11-18 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-17 23:59:59' AND DateTime < '2004-11-19 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-18 23:59:59' AND DateTime < '2004-11-20 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-19 23:59:59' AND DateTime < '2004-11-21 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-20 23:59:59' AND DateTime < '2004-11-22 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-21 23:59:59' AND DateTime < '2004-11-23 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-22 23:59:59' AND DateTime < '2004-11-24 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-23 23:59:59' AND DateTime < '2004-11-25 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-24 23:59:59' AND DateTime < '2004-11-26 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-25 23:59:59' AND DateTime < '2004-11-27 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-26 23:59:59' AND DateTime < '2004-11-28 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-27 23:59:59' AND DateTime < '2004-11-29 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-28 23:59:59' AND DateTime < '2004-11-30 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2004-11-29 23:59:59' AND DateTime < '2004-12-01 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
