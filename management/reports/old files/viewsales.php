...
<table width="70%" border="0" cellpadding="7" align="center" cellspacing="0" bordercolor="#003399">
     ...
     <tr> 
     <td><div><font size="2" face="Arial, Helvetica, sans-serif"><strong>Revene 
        from Sales</strong></font></div></td>
    <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo "$ "; echo number_format($totSales,2); ?></strong></font></div></td>
    </tr>
	</table>
	...
	<table width="70%" border="0" cellpadding="7" align="center" cellspacing="0" bordercolor="#003399">
		...
		<tr> 
			<td><div><font size="2" face="Arial, Helvetica, sans-serif"><strong>Cost Of Good Sold</strong></font></div></td>
		...
		<tr> 
		 <td><div><font size="2" face="Arial, Helvetica, sans-serif"><strong>Tax collected</strong></font></div></td>
		 <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo "$ "; echo number_format($totTax,2); ?></strong></font></div></td>
     	</tr>		  
		<tr> 
