...
<table width="100%"  border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
		...
		for($i=1; $i<= 12; $i++)
		{
			...
			$sql3 = "SELECT tblPurchase2.PurchaseID, tblCustomer.CustomerID, tblPurchase2.CustomerID, tblPurchase2.OrderDateTime, tblPurchaseDetails2.PurchaseID,
			tblPurchaseDetails2.ProductID, Sum(tblPurchaseDetails2.Quantity) as Quantity, tblPurchase2.Status, tblPurchaseDetails2.Status
			FROM tblCustomer
		   ...
		   <?
			...
			?>
              Total Timers: <strong><font color="<? echo $Color; ?>" size="2" face="Arial, Helvetica, sans-serif"><? echo $Quantity; ?></font></strong></div></td>
			<?
			  	}
			?>
	</tr>
