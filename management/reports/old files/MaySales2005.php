...
- May 2005 </strong></font>
<form>
  <?

	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-04-30 23:59:59' AND DateTime < '2005-05-02 00:00:00' AND Status = 'active'";
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-01 23:59:59' AND DateTime < '2005-05-03 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-02 23:59:59' AND DateTime < '2005-05-04 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-03 23:59:59' AND DateTime < '2005-05-05 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-04 23:59:59' AND DateTime < '2005-05-06 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-05 23:59:59' AND DateTime < '2005-05-07 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-06 23:59:59' AND DateTime < '2005-05-08 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-07 23:59:59' AND DateTime < '2005-05-09 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-08 23:59:59' AND DateTime < '2005-05-10 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-09 23:59:59' AND DateTime < '2005-05-11 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-10 23:59:59' AND DateTime < '2005-05-12 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-11 23:59:59' AND DateTime < '2005-05-13 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-12 23:59:59' AND DateTime < '2005-05-14 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-13 23:59:59' AND DateTime < '2005-05-15 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-14 23:59:59' AND DateTime < '2005-05-16 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-15 23:59:59' AND DateTime < '2005-05-17 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-16 23:59:59' AND DateTime < '2005-05-18 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-17 23:59:59' AND DateTime < '2005-05-19 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-18 23:59:59' AND DateTime < '2005-05-20 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-19 23:59:59' AND DateTime < '2005-05-21 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-20 23:59:59' AND DateTime < '2005-05-22 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-21 23:59:59' AND DateTime < '2005-05-23 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-22 23:59:59' AND DateTime < '2005-05-24 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-23 23:59:59' AND DateTime < '2005-05-25 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-24 23:59:59' AND DateTime < '2005-05-26 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-25 23:59:59' AND DateTime < '2005-05-27 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-26 23:59:59' AND DateTime < '2005-05-28 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-27 23:59:59' AND DateTime < '2005-05-29 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-28 23:59:59' AND DateTime < '2005-05-30 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-29 23:59:59' AND DateTime < '2005-05-31 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	$sql = "SELECT Sum(NumOrdered) AS Sum FROM tblPurchase WHERE DateTime > '2005-05-30 23:59:59' AND DateTime < '2005-06-01 00:00:00' AND Status = 'active'";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
