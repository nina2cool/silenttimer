...
<?
	...
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2003-08-31 23:59:59' AND tblPurchase2.OrderDateTime < '2003-10-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.1");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2003-09-30 23:59:59' AND tblPurchase2.OrderDateTime < '2003-11-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.2");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2003-10-30 23:59:59' AND tblPurchase2.OrderDateTime < '2003-12-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.3");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2003-11-30 23:59:59' AND tblPurchase2.OrderDateTime < '2004-01-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.4");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2003-12-31 23:59:59' AND 
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-01-31 23:59:59' AND 
...
$sql = "SELECT Sum(tblPurchaseDetails2.Quantity) AS Sum, tblPurchase2.OrderDateTime, tblPurchaseDetails2.ProductID,
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-02-28 23:59:59' AND 
...
$sql = "SELECT Sum(tblPurchaseDetails2.Quantity) AS Sum, tblPurchase2.OrderDateTime, tblPurchaseDetails2.ProductID,
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-03-31 23:59:59' AND 
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-04-30 23:59:59' AND 
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-05-31 23:59:59' AND tblPurchase2.OrderDateTime < '2004-07-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-06-30 23:59:59' AND tblPurchase2.OrderDateTime < '2004-08-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-07-31 23:59:59' AND tblPurchase2.OrderDateTime < '2004-09-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-08-31 23:59:59' AND tblPurchase2.OrderDateTime < '2004-10-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-09-30 23:59:59' AND tblPurchase2.OrderDateTime < '2004-11-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-10-31 23:59:59' AND tblPurchase2.OrderDateTime < '2004-12-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-11-30 23:59:59' AND tblPurchase2.OrderDateTime < '2005-01-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2004-12-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-02-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-01-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-03-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-02-28 23:59:59' AND tblPurchase2.OrderDateTime < '2005-04-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-03-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-05-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-04-30 23:59:59' AND tblPurchase2.OrderDateTime < '2005-06-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-05-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-07-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-06-30 23:59:59' AND tblPurchase2.OrderDateTime < '2005-08-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-07-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-09-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-08-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-10-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-09-30 23:59:59' AND tblPurchase2.OrderDateTime < '2005-11-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-10-31 23:59:59' AND tblPurchase2.OrderDateTime < '2005-12-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
	...
	INNER JOIN tblProduct
	ON tblPurchaseDetails2.ProductID = tblProduct.ProductID
	WHERE tblProduct.Timer = 'y' AND tblPurchase2.OrderDateTime > '2005-11-30 23:59:59' AND tblPurchase2.OrderDateTime < '2006-01-01 00:00:00' AND tblPurchaseDetails2.Status = 'active'
	GROUP BY tblProduct.Timer";
	$result = mysql_query($sql) or die("Cannot retrieve purchase info, please try again.");
