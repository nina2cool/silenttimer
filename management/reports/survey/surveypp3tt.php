...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql4 = "SELECT Count(SurveyID) as Total from tblSurvey WHERE Status = 'active' AND SurveyName = 'PP3TT'";
...
<?
	   ...
	   <td><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Answer; ?>
					  ...
					  $SurveyID = $row7[SurveyID];
					   ...
					   ?>
						   ...
						   <li><? echo $OtherText; ?> (<a href="surveypp3ttresult.php?s=<? echo $SurveyID; ?>" target="_blank"><? echo $SurveyID; ?></a>)</li>
  ...
  <?
		  ...
		  ?>
  			...
  			<?
			$sql55 = "SELECT * FROM tblSurveyQA WHERE QuestionID = '110' AND Status = 'active' AND OtherText <> ''";
...
<font color="#000000" size="2">(<? echo $CountComments; ?> comments)</font></font></p>
		  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
			...
			$sql66 = "SELECT * FROM tblSurveyQA WHERE QuestionID = '110' AND Status = 'active' AND OtherText <> '' ORDER BY SurveyID ASC";
			...
			?>
              <td><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Comments; ?> (<a href="surveypp3ttresult.php?s=<? echo $SurveyID; ?>" target="_blank"><? echo $SurveyID; ?></a>) </font></td>
            </tr>
			<?
			}
			?>
