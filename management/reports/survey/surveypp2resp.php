...
<form>
  <?
	...
	$sql = "SELECT * FROM tblSurvey WHERE SurveyName = 'PP2'";
...
?>
	...
	?>
    <tr>
     <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="surveypp2result.php?s=<? echo $SurveyID; ?>" target="_blank"><? echo $SurveyID; ?></a></font></div></td>
