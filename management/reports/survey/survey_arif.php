  ...
  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
	...
	<?
		...
		$AnswerID = $row8[AnswerID];
				...
				$sql9 = "SELECT Count(AnswerID) as TotalCount from tblSurveyQA WHERE QuestionID = '$QuestionID' AND Status = 'active' AND AnswerID <> '0' AND OtherText <> ''";
				//echo $sql9;
	...
	?>
	   ...
	   <td><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Answer; ?>
							...
							<? 
					  $sql7 = "SELECT OtherText, SurveyID, Count(OtherText) as Count FROM tblSurveyQA WHERE OtherText <> '' AND Status = 'active' AND AnswerID = '$AnswerID' GROUP BY OtherText";
