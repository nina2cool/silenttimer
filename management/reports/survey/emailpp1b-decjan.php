...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif">PP #1B
    Customers</font></p>
<p><font color="#000000" size="3" face="Arial, Helvetica, sans-serif">Dec 2005
and January 2006 </font></p>
  ...
  <?
	...
	*/
	...
	$sql = "SELECT tblCustomer.FirstName, tblCustomer.LastName, tblCustomer.Email, tblCustomer.CustomerID, tblPurchase2.OrderDateTime,
	tblPurchase2.PurchaseID
	FROM tblPurchase2
	INNER JOIN tblCustomer
	ON tblPurchase2.CustomerID = tblCustomer.CustomerID
	WHERE tblPurchase2.OrderDateTime >= '2005-12-01' AND tblPurchase2.OrderDateTime < '2006-02-01' AND tblCustomer.Type <> '6' AND tblCustomer.Type <> '5'
	AND tblCustomer.Type <> '7' AND tblCustomer.Type <> '8'
	GROUP BY tblCustomer.CustomerID
	ORDER BY tblPurchase2.OrderDateTime
	";
...
?>
    <tr bgcolor="#FFFFCC">
      ...
      <td class=sort><div align="center"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">Claim?</font></strong></font></div></td>
      <?
