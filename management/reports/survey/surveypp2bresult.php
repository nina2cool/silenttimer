...
#</font></strong><font face="Arial, Helvetica, sans-serif">: <strong><? echo $Question; ?></strong></font></font></p>
  ...
  <?
		  ...
		  ?>
  			...
  			<?
			$sql55 = "SELECT * FROM tblSurveyQA WHERE QuestionID = '64' AND Status = 'active' AND OtherText <> '' AND SurveyID = '$SurveyID'";
...
<font color="#000000" size="2">(<? echo $CountComments; ?> comments)</font></font></p>
		  <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
			...
			$sql66 = "SELECT * FROM tblSurveyQA WHERE QuestionID = '64' AND Status = 'active' AND OtherText <> '' AND SurveyID = '$SurveyID'";
