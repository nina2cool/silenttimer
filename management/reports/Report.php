...
require "../include/headerbottom.php";
	...
	$FromDate = "$Year-$Month-01";
		...
		{
		?>
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Sales Report for <u><?php echo $MonthName; ?></u></strong></font> <u><font color="#003399"
 ...
 size="5" face="Arial, Helvetica, sans-serif"><strong><?php echo $EndDate; ?></strong></font></u>
	...
	*/
	...
	WHERE tblPurchase2.OrderDateTime >= '$FromDate' AND tblPurchase2.OrderDateTime <= '$ToDate' GROUP BY tblProductNew.ProductID ORDER BY Nickname ASC";
...
?>	
	    <tr>
      <td><div align="center"><font color="<? echo $Color; ?>" size="2" face="Arial, Helvetica, sans-serif"><strong><?php echo $Nickname; ?></strong></font></font> - #<? echo $ProductID; ?></div></td>
 ...
 <p>
	...
	*/
	...
	$sql6 = "SELECT tblPurchase2.PurchaseID, tblPurchase2.OrderDateTime, tblPurchase2.ShippingCost, tblPurchase2.Tax,
	tblPurchase2.Subtotal, tblPurchase2.Discount, tblPurchaseDetails2.ProductID, tblPurchase2.Shipped, tblProductNew.Cost, tblProductNew.BuiltInShipCost, tblPurchaseDetails2.Quantity, tblShipment3.ShipmentCost
	FROM tblPurchase2
	INNER JOIN tblPurchaseDetails2
	ON tblPurchase2.PurchaseID = tblPurchaseDetails2.PurchaseID
	INNER JOIN tblProductNew
	ON tblPurchaseDetails2.ProductID = tblProductNew.ProductID
	LEFT JOIN tblShipment3
	ON tblPurchase2.PurchaseID = tblShipment3.PurchaseID
	...
	$InvCost0 = 0;
					...
					$InvCost2 = $InvCost3 + $InvCost*$Quantity;
 ...
 ?>
   <strong><font size="3" face="Arial, Helvetica, sans-serif">Sales Summary (based on items sold but not necessarily shipped)</font></strong><br>
 </p>
<table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
   <tr>
