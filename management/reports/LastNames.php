...
of People with Last Name</strong></font>
<?

	$sql = "SELECT Count(LastName) as Count, LastName FROM tblCustomer GROUP BY LastName ORDER BY Count DESC, LastName ASC";
...
?>
	...
	?>
    <tr> 
      <td width="130"> <div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><? echo $LastName; ?></font></strong></div></td>
