...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>#
  of Bookstores by State </strong></font>
  <?

	$sql = "SELECT Count(State) as Count, State FROM tblBusinessCustomer WHERE CustomerType = 'Bookstore' AND Status = 'active' GROUP BY State ORDER BY Count DESC, State ASC";
...
?>
	...
	
	{
		...
		$Num = $row['Count'];
			...
			$sql2 = "SELECT * FROM tblState WHERE State = '$State2'";
