...
//	tblEmployee.EmployeeID = tblEmployeeCustomer.EmployeeID";
	...
	//sort results.....
			...
			{
				$sql .= " ORDER BY tblBusinessCustomer.CustomerType ASC";
				$sortBy ="tblBusinessCustomer.CustomerType";
				$sortDirection = "ASC";
			}
...
?>
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Business 
...
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#CCCCCC">
  ...
  <tr bgcolor="#FFFFCC"> 
    ...
    <td width="20%" bgcolor="#FFFFCC" class=sort> <div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="../businesscustomer/BusCustView.php?sort=tblBusinessCustomer.Name&d=<? if ($sortBy=="tblBusinessCustomer.Name") {echo $sd;} else {echo "ASC";} ?>">        Name</a></font></strong></font></div></td>
    ...
    <td width="15%" class=sort><div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="../businesscustomer/BusCustView.php?sort=tblBusinessCustomer.City&d=<? if ($sortBy=="tblBusinessCustomer.City") {echo $sd;} else {echo "ASC";} ?>">City</a>, 
            <a href="../businesscustomer/BusCustView.php?sort=tblBusinessCustomer.State&d=<? if ($sortBy=="tblBusinessCustomer.State") {echo $sd;} else {echo "ASC";} ?>">State</a></strong></font></div></td>
    ...
    <td width="14%" class=sort> <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="../businesscustomer/BusCustView.php?sort=tblBusinessCustomer.CustomerType&d=<? if ($sortBy=="tblBusinessCustomer.CustomerType") {echo $sd;} else {echo "ASC";} ?>">Business 
  ...
  <tr> 
    ...
    <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $BusinessType; ?></font></div></td>
  </tr>
  <?
			  	}
