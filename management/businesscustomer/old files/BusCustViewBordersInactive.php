...
//	tblEmployee.EmployeeID = tblEmployeeCustomer.EmployeeID";
	...
	$sql = "SELECT * from tblBusinessCustomer WHERE Status ='inactive' AND CustomerType = 'Bookstore' AND Chain = 'Borders'";
...
<p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Inactive
      Borders Bookstores </strong></font></p>
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">This is
     a list of all the inactive Borders bookstores in our database. There are <? echo $sum; ?> inactive
     bookstores in the database.</font></p>
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  ...
  <tr bgcolor="#FFFFCC"> 
    ...
    <td width="20%" bgcolor="#FFFFCC" class=sort> <div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="../businesscustomer/BusCustViewBordersInactive.php?sort=tblBusinessCustomer.Name&d=<? if ($sortBy=="tblBusinessCustomer.Name") {echo $sd;} else {echo "ASC";} ?>">Store 
        Name</a></font></strong></font></div></td>
    <td width="15%" class=sort><div align="center"><font color="#003399"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="../businesscustomer/BusCustViewBordersInactive.php?sort=tblBusinessCustomer.BordersStoreNumber&d=<? if ($sortBy=="tblBusinessCustomer.BordersStoreNumber") {echo $sd;} else {echo "ASC";} ?>">Store
              Number</a> </font></strong></font></div></td>
    <td width="15%" class=sort><div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="../businesscustomer/BusCustViewBordersInactive.php?sort=tblBusinessCustomer.City&d=<? if ($sortBy=="tblBusinessCustomer.City") {echo $sd;} else {echo "ASC";} ?>">City</a>, 
        <a href="../businesscustomer/BusCustViewBordersInactive.php?sort=tblBusinessCustomer.State&d=<? if ($sortBy=="tblBusinessCustomer.State") {echo $sd;} else {echo "ASC";} ?>">State</a></strong></font></div></td>
    <td width="12%" class=sort> <div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong><a href="../businesscustomer/BusCustViewBordersInactive.php?sort=tblBusinessCustomer.Phone1&d=<? if ($sortBy=="tblBusinessCustomer.Phone1") {echo $sd;} else {echo "ASC";} ?>">Main 
  ...
  <?
				...
				$City = $row[City];
				$State = $row[State];
				$StoreNumber = $row[BordersStoreNumber];
  ...
  <tr> 
    ...
    <td width="15%"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $StoreNumber; ?></font></td>
