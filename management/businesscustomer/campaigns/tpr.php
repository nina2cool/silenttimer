...
//	tblEmployee.EmployeeID = tblEmployeeCustomer.EmployeeID";
	...
	$sql = "SELECT * from tblBusinessCustomer WHERE Status ='active' AND CustomerType = 'Test Prep' AND Chain = 'Princeton Review'";
...
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">This is
     a list of all the test prep companies in our database. There are <? echo $sum; ?> Princeton
     Reviews in the database.</font></p>
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#003399">
  ...
  <tr bgcolor="#FFFFCC"> 
    ...
    <td width="" class=sort><div align="center"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>City, 
        <a href="../businesscustomer/BusCustViewBookstore.php?sort=tblBusinessCustomer.State&d=<? if ($sortBy=="tblBusinessCustomer.State") {echo $sd;} else {echo "ASC";} ?>">State</a></strong></font></div></td>
  ...
  <?
			  ...
			  ?>
  <tr> 
    <td width=""> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="../businesscustomer/BusCustEdit.php?bc=<? echo $cID; ?>"><strong>Details</strong></a></font></div></td>
    ...
    <td width=""><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $City; ?>, 
        <? echo $State; ?> <? echo $ZipCode; ?></font></div></td>
