    ...
    <TD width="161" align="left" valign="top" background="images/behind-left-gray.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <table width="100%" border="0" cellpadding="6" cellspacing="0" bordercolor="#000000">
            ...
            <tr>
              <td align="left" valign="top" class=box1><div align="right"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>businesscustomer/campaigns/index.php"> &lt;&lt; Campaigns </a></font></div></td>
            </tr>
            <tr>
            ...
            <tr> 
              <td align="left" valign="top" class=box1><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>businesscustomer/campaigns/index.php">View
                      Campaigns</a></font></div></td>
            </tr>
            <tr> 
