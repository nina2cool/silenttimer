...
<?
	...
	$sql = "SELECT * FROM tblBusinessCustomer WHERE CheckStore = 'y'";
...
?>
  ...
  <tr> 
    ...
    <td width="5%"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="letter.php?id=<? echo $BusinessCustomerID; ?>" target="_blank">PL</a></font></div></td>
    <td width="5%"><font size="2" face="Arial, Helvetica, sans-serif"> 
      <? if($StoreClose == 'y'){?>
      <a href="flier.php?id=<? echo $BusinessCustomerID; ?>" target="_blank">RS</a> 
      <? } ?>
      </font></td>
  </tr>
  <?
