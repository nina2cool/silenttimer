...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "SELECT * FROM tblBusinessCustomer WHERE Country = 'US' AND Chain = 'Kaplan' AND Status = 'active' AND State <> 'AZ' AND State <> 'HI' AND State <> 'DC'
	AND State <> 'NV' AND State <> 'MS' AND State <> 'NE' AND State <> 'UT' AND State <> 'VT'";
...
and Fliers for Kaplan  = <? echo $Count; ?> total</strong></font></p>
