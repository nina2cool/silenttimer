...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	WHERE Chain = '' AND CustomerType = 'Test Prep' AND Country = 'US' AND State = '$State' AND PromotionCodeID <> ''";
	...
	{
		$sql .= " ORDER BY tblBusinessCustomer.City ASC, tblBusinessCustomer.ZipCode";
...
?>
  <tr bgcolor="#CCCCCC"> 
    <td class=sort> <div align="center"><strong><a href="campaign-testprep.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.BusinessCustomerID&d=<? if ($sortBy=="tblBusinessCustomer.BusinessCustomerID") {echo $sd;} else {echo "ASC";}?>"><font size="2" face="Arial, Helvetica, sans-serif">BusCustID</font></a></strong></div></td>
    <td class=sort><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">Chain
            - <a href="campaign-testprep.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.Name&d=<? if ($sortBy=="tblBusinessCustomer.Name") {echo $sd;} else {echo "ASC";}?>">Name</a> </font></strong></div></td>
    <td class=sort><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="campaign-testprep.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.Address&d=<? if ($sortBy=="tblBusinessCustomer.Address") {echo $sd;} else {echo "ASC";}?>">Address</a></font></strong></div></td>
    <td class=sort><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="campaign-testprep.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.City&d=<? if ($sortBy=="tblBusinessCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a>, <a href="campaign-testprep.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.State&d=<? if ($sortBy=="tblBusinessCustomer.State") {echo $sd;} else {echo "ASC";}?>">St.</a> <a href="campaign-testprep.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.ZipCode&d=<? if ($sortBy=="tblBusinessCustomer.ZipCode") {echo $sd;} else {echo "ASC";}?>">Zip</a> </font></strong></div></td>
