...
<p><font color="#000000"><font size="2" face="Arial, Helvetica, sans-serif">&lt;
      <a href="ContactView.php">View Active Contacts </a></font></font></p>
<div align="right"><font size="2" face="Arial, Helvetica, sans-serif">E = Edit
    | A = Add Log| H = History</font></div><br>
<table width="100%" border="1" cellpadding="7" cellspacing="0" bordercolor="#CCCCCC">
    <?
			  
			  	$sql = "SELECT * FROM tblContact WHERE Status = 'inactive'
				";
...
?>
    ...
    <tr <? if($Status == "inactive") { ?>bgcolor="#CCCCCC"<? } ?>>
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif"><font><? echo $FirstName; ?></font> <? echo $LastName; ?></font> </td>
      <td><font size="2" face="Arial, Helvetica, sans-serif"> <? echo $Phone; ?>
            <? if($Ext <> "") { ?>
    Ext <? echo $Ext; ?>
    <? } ?>
      </font></td>
      <td><font size="2" face="Arial, Helvetica, sans-serif"><a href="mailto:<? echo $Email; ?>"><? echo $Email; ?></a></font></td>
      <td nowrap><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="ContactEdit.php?c=<? echo $ContactID; ?>">E</a> | <a href="ContactLogAdd.php?c=<? echo $ContactID; ?>">A</a> | </font> <font size="2" face="Arial, Helvetica, sans-serif"><a href="ContactHistory.php?c=<? echo $ContactID; ?>">H</a></font></div></td>
    </tr>
    <?
			  	}
