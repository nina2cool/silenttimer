...
$sql = "INSERT INTO tblContact(FirstName, LastName, Company, Title, Address, Address2, City, State, ZipCode, Phone, Ext, Fax, Email, URL, Notes, Status)
VALUES('$FirstName', '$LastName', '$Company', '$Title', '$Address', '$Address2', '$City', '$State', '$ZipCode', '$Phone', '$Ext', '$Fax', '$Email', '$URL', '$Notes', 'active');";
