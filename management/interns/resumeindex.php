...
<?
			...
			if($_GET['Status'] == "hired")
	{
		...
		$sql = "UPDATE tblResume
				SET Status = 'hired' 
				WHERE ResumeID = '$ResumeID';";
		mysql_query($sql) or die("Cannot hired resume, try again!");
	}
	
	
	$sql = "Select * FROM tblResume WHERE Status = 'active'";
...
?>
<font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Active 
Resume Index</strong></font> 
<form>
...
?>
    <tr bgcolor="#CCCCCC"> 
      ...
      <td width="35%" class=sort><div align="center"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">Delete 
          Resume</font></strong></font></div></td>
      <td width="35%" class=sort><div align="center"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">Hired 
          Resume</font></strong></font></div></td>
    ...
    <tr> 
      ...
      <td width="35%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="resumeindex.php?<? echo "ResumeID=$ResumeID&Status=inactive";?>">Delete</a></font></div></td>
      <td width="35%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="resumeindex.php?<? echo "ResumeID=$ResumeID&Status=hired";?>">Hired</a></font></div></td>
  ...
  <p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>&gt; 
    <a href="resumehired.php">Hired Intern Resumes</a></strong></font></p>
  <p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>&gt; 
