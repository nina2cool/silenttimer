...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	$sql = "Select * FROM tblEmployee WHERE Type = 'Intern' AND Status = 'inactive'";
...
?>
  ...
  <p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>&gt; 
    <a href="internview.php">View Active Interns</a></strong></font></p>
  <p align="left">&nbsp;</p>
