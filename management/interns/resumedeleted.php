...
<?
	...
	$sql = "Select * FROM tblResume WHERE Status = 'inactive'";
...
?>
<font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Deleted/Inactive 
...
?>
    <tr bgcolor="#CCCCCC"> 
      ...
      <td width="35%" class=sort><div align="center"><font color="#000000"><strong><font size="2" face="Arial, Helvetica, sans-serif">Reinstate</font><font size="2" face="Arial, Helvetica, sans-serif"> 
          Resume </font></strong></font></div></td>
    ...
    <tr> 
      ...
      <td width="35%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="resumedeleted.php?<? echo "ResumeID=$ResumeID&Status=active";?>">Reinstate</a></font></div></td>
