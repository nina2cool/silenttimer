			...
			while($row5 = mysql_fetch_array($result5))
				...
				$QuestionNum = $row5[QuestionID];
							...
							if($CheckAll == 'n')
							{
									...
									elseif($QuestionNum == 67)
									{
									$Answer = $_POST['67'];
									}
									elseif($QuestionNum == 68)
									{
									$Answer = $_POST['68'];
									}
									elseif($QuestionNum == 69)
									{
									$Answer = $_POST['69'];
									}
									elseif($QuestionNum == 70)
									{
									$Answer = $_POST['70'];
									}
									elseif($QuestionNum == 71)
									{
									$Answer = $_POST['71'];
									}
									elseif($QuestionNum == 72)
									{
									$Answer = $_POST['72'];
									}
									else
									...
									#Survey PP3ST has no "other" answers.
...
do
		...
		mail("info@silenttimer.com", "New Timer Survey - PP3ST", "New PP3ST survey entry for $now...from $FirstName $LastName", "From:Timer Survey");
		...
		$sql = "SELECT * FROM tblSurveyQuestions WHERE Status = 'active' AND SurveyName = 'PP3ST' AND Display = 'y'";
