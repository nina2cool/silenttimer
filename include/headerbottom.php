		...
		else
		{
          ...
          <tr> 
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr> 
                      ...
                      <td width="36%"><input name="ZipCode" type="text" id="ZipCode2" size="7" maxlength="5">
                        ...
                        <font size="2" face="Arial, Helvetica, sans-serif"><em><font size="1" face="Arial, Helvetica, sans-serif">Enter
                        your U.S. zip code</font></em></font> </td>
                    </tr>
                  </table>
            ...
            <td width="32%" valign="middle"><div align="left"> 
                <p align="right"><em>                </em><font size="2" face="Arial, Helvetica, sans-serif"><a href="<? echo $http; ?>customerservice">My
                  Account</a> | <a href="<? echo $http; ?>shoppingcart.php">Shopping
                  Cart</a> </font></p>
            </div></td>
