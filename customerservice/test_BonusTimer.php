...
//CODE GOES BELOW-----------------------------------------------------------
	...
	if ($_POST['Order'] == ">> Order my Bonus Timer")
	{
		...
		?>
		<meta http-equiv='refresh' content='0;URL=<? echo $http; ?>customerservice/test_home.php'>
		<?
...
{
?>
            <p><font color="#003399"><strong><font size="5" face="Arial, Helvetica, sans-serif">&gt;
        Order My LSAT Bonus Timer</font></strong></font></p>
...
<p><font size="2" face="Arial, Helvetica, sans-serif">It will be shipped via
    ...
    us otherwise in the comment box).</font></p>
<form name="form1" method="post" action="">
  ...
  in &quot;</font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $LastFourCr; ?></strong></font><font color="#000000">&quot; when the bonus timer is ready for shipment. </font></strong></font></p>
  <p>
...
<table width="650" height="800"  border="0" align="center" cellpadding="5" cellspacing="0">
	...
	<td>	       
      ...
      to receive your bonus timer: </u></strong></font></p>      <ol>
        ...
        <li>Once all the above materials have been submitted properly, your bonus
          timer will be mailed to you via USPS First Class mail. Expect a turnaround
          time of 2 business days from the time we receive your materials. You
      ...
      <p><font size="2" face="Times New Roman, Times, serif">Please print legibly.<strong> Bonus
            timer 
    offer expires October 31, 2006.</strong></font></p></td>
  </tr>
  ...
  <tr>
    <td><p><font size="2" face="Times New Roman, Times, serif">      Receive
          ...
          receipt of properly completed  submission.  Submission must be postmarked
