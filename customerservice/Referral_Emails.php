...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
			...
			if($Email1 != "")
			{
				...
				$html =
					...
					<ul>
				      ...
				      <li><strong><font size='2' face='Arial, Helvetica, sans-serif'>Silent Simple Timer</font></strong></li>
    ...
    Enter &quot;$CustomerID&quot; on the order page where it asks for the promotion code. </font></p>
			...
			?><title>Friend Referral Program - Step 2</title>
...
// write funciton to check and make sure emaisl aer correct...
	...
	function CheckEmails()
	{
      ...
      Step 2: Sending Emails </strong></font></td>
                <td><div align="right">
                  <p><strong><font size="2" face="Arial, Helvetica, sans-serif">&lt; <a href="Referral_Info.php">Step 1: How the program works </a></font></strong></p>
...
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Once you
    ...
    price refunded! (<a href="Referral_Info.php">Read more here</a>)<br>
</font></p>
