...
<form name="form1" method="post" action="">
  ...
  <p><font size="2" face="Arial, Helvetica, sans-serif">If you have a <font color="#33CC33"><strong>testimonial</strong></font> you'd
      like to give about The Silent Timer, write your testimonial in the space
      below. Please check the box that says it is okay to post your comment on
      our web site (in the <a href="http://www.silenttimer.com/stories/" target="_blank">testimonial
    section</a>) along
