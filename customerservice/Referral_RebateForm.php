			...
			<table width="650" height="802"  border="0" align="center" cellpadding="5" cellspacing="0">
              <tr>
                <td height="400"><table width="100%"  border="0" cellspacing="2" cellpadding="5">
                  ...
                  <tr valign="top">
                    <td width="65%"><p><font size="2" face="Times New Roman, Times, serif"><strong><u>In
                              order to receive your rebate check for in-store
                              purchases: </u></strong></font></p>
                        <ol>
                          ...
                          <li><font size="2" face="Times New Roman, Times, serif"> Mail
                              ...
                              to: <strong>Silent
                              Technology LLC, ATTN: Rebates, PO Box 27037, Austin,
                              TX 78755.<br>
                              <br>
                    ...
                    <td colspan="2"><p align="left"><font size="2" face="Times New Roman, Times, serif"><u><strong>You
                              can also receive 5% off online:</strong></u></font></p>
