...
<?
 # <p><img src="pics/Front-Logo-blue.jpg" width="150" height="98"></p>
	...
	$sql = "SELECT * FROM tblProductNew WHERE OnHand > '0' AND CategoryID = $CategoryID ORDER BY Priority";
	//put SQL statement into result set for loop through records
	...
	<p align="right"> <font size="3" face="Arial, Helvetica, sans-serif"><b>$<? echo number_format($Price,2); ?>
	
	<? if($Preorder == "y") { ?>
	<br>
	      
	<font color="#FF0000" size="2">Pay only $<? echo number_format($PreorderPrice,2); ?> now!</font>	
	...
	{#Show Out of Stock
	?>
	<p align="right"> <font size="2" face="Arial, Helvetica, sans-serif" color="#FF0000">Temporarily Unavailable</font></p>
	<?
	}
	else
	...
	<form name="Add_To_Cart" method="post" action=""> 
	  ...
	  <input name="Add To Cart" type="image" id="Add To Cart" value="Add To Cart" src="../images/addtocart.jpg" width="140" height="27" alt="Add Item To Cart">
	  </font>	 
