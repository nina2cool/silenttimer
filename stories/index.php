...
<p><font color="#9900CC" size="2" face="Arial, Helvetica, sans-serif"><strong>Some
      of the testimonials may include references to using The Silent Timer on
      their test. Check with your exam board for current rules, as some tests
may have changed their regulations since.</strong></font></p>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <?
  		...
  		$sql = "SELECT Name, Testimonial, DATE_FORMAT(Date, '%m/%d/%Y') AS Date, Location, Test, Priority FROM tblTestimonial WHERE Status = 'active' AND Web = 'y'";
  ...
  ?>
	    ...
	    <tr>
          <td align="left" valign="top"><DIV><SPAN class=000572515-14112005></SPAN></DIV>
            <DIV>
              <p><font size="2" face="Arial"><SPAN class=000572515-14112005><em>"<? echo $Testimonial; ?>"</em>
		...
		?>
              ...
              <blockquote>
                <p><font color="#333333" size="2" face="Arial, Helvetica, sans-serif"><SPAN class=000572515-14112005><strong><em><? echo $Name; ?><br>
                          <? echo $Test; ?><br>
                          <? echo $Location; ?></em></strong></SPAN></font></p>
              </blockquote>
		<?
		}
		else
      ...
      <p><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong>Bad 
        Dream...</strong></font></p>
      <p><font size="2" face="Arial, Helvetica, sans-serif"><img width="132" height="108" class="right">You 
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><img width="131" height="107" class="right">You 
    ...
    <td width="16%" align="left" valign="top">    <p>&nbsp;</p>
      <p>&nbsp;</p>
      ...
      <tr>
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="6">
            <tr>
              <td bgcolor="#FF0000"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Tell
                    your Story</strong></font></td>
            </tr>
            <tr>
              <td align="left" valign="top" bgcolor="#FFFFFF"><p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Email
                    us your timing story, or testimonials for using <font color="#000066" face="Times New Roman, Times, serif"><strong>THE
                    SILENT TIMER</strong></font><strong>&#8482;</strong>.
