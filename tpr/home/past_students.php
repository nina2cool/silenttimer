  ...
  <tr> 
    <td align="left" valign="top"><p><font color="#003399" size="5" face="Arial, Helvetica, sans-serif"><strong>Student 
      ...
      <p><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Here 
        is a list of students who have already picked up their timer. </font></strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">To 
        see students who have NOT picked up their timer, <a href="students.php">click 
        here</a>.</font></p>
      <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
        <tr align="center" valign="top" bgcolor="#000066"> 
          <td width="68%"> <div align="left"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Student 
              Name </font></strong></div></td>
          <td width="32%"><div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pickup 
              Date</font></strong></div></td>
        </tr>
        <?
		# - get list of all students who have NOT picked up their timers yet...
	  	$sql = "SELECT tblPurchase.PurchaseID, tblCustomer.FirstName, tblCustomer.LastName, DATE_FORMAT(tblAffStudentReceived.DateTime,'%m/%d/%Y') AS DateTime 
				...
				WHERE tblPurchase.AffOfficeID = '$aID' AND tblAffStudentReceived.DateTime IS NOT NULL
		...
		while($row = mysql_fetch_array($result))
		{
			...
			$DT = $row[DateTime]; // date and time they picked it up
			
?>
        <tr align="center" valign="top"> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Name;?></font></div></td>
          <td><div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><? echo $DT;?></font></div></td>
        </tr>
        <?
		}
?>
