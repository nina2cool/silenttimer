...
<p align="left"><font size="2" face="Arial, Helvetica, sans-serif">Here is a
    list of stores within <? echo $RadiusGiven; ?> miles of zip code <? echo $ZipCodeGiven; ?> that now
    carry our timer. Instead of ordering online, get your timer today from any
    of the following bookstores. AND, if a store doesn't have it in stock, they
    can order it for you!</font></p>
<p align="left"><font size="2" face="Arial, Helvetica, sans-serif">The timer
    should be in the Test Prep/Study Aid Section. If not, check behind the register
and at the front of the store. When in doubt, ask an employee for help.</font></p>
<p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Please
    note that these stores only stock The Silent Timer&#8482;, not the watch.</strong></font></p>
<table width="100%" border="1" cellpadding="8" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#003399">
    <td width="" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif">Store
          Location</font></strong></td>
    <td width="" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif">Address</font></strong></td>
    <td width="" bgcolor="#FFFFCC"><div align="left"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>City</strong></font></div></td>
    <td width="" bgcolor="#FFFFCC"><div align="left"><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><strong>Phone
            #</strong></font></div></td>
...
?>
  <tr>
    <td><font size="2" face="Arial, Helvetica, sans-serif">
      ...
      <a href="store_info.php?s=<? echo $BusinessCustomerID; ?>">
    ...
    <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $City;?></font></div></td>
    <td width="15%"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $Phone1;?></font></div></td>
    <?
	if($Rebate == 'y')
	{
	?>
    <td bgcolor="#D9ECFF"><div align="center"><a href="order/rebate.php?rebate=<? echo $BusinessCustomerID; ?>&z=5&code=<? echo $PromotionCodeID; ?>" target="_blank"><img src="order/pics/off2.jpg" alt="$5 Rebate!" width="50" height="43" border="0"></a> </div></td>
    <td bgcolor="#D9ECFF"><div align="center">
        <p> <font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><a href="http://www.SilentTimer.com/order/rebate.php?rebate=<? echo $BusinessCustomerID; ?>&z=5&code=<? echo $PromotionCodeID; ?>" target="_blank">$5
