...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	if ($_POST['Go'] == "Go")
	{
		...
		/*
		?>
		<meta http-equiv='refresh' content='0;URL=http://www.silenttimer.com/locations_state.php?state=<? echo $State; ?>'>	
		<?
		*/
	}
...
<DIV>
  <p><font size="2" face="Arial, Helvetica, sans-serif"><strong>THE SILENT TIMER
        LSAT BONUS COMBO IS NOT IN ALL OF THE STORES YET. SPECIFY WHEN CALLING
  THAT YOU ARE LOOKING FOR THE COMBO THAT HAS 2 TIMERS IN IT.</strong></font></p>
  ...
  <p><font size="2" face="Arial, Helvetica, sans-serif"><strong>Please note that
  these stores only stock The Silent Timer&#8482;, not the watch. </strong></font></p>
</DIV>
<p align="left">
  <?
...
<table width="100%" border="1" cellpadding="8" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#003399"> 
    <td width="" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_state.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.Chain&d=<? if ($sortBy=="tblBusinessCustomer.Chain") {echo $sd;} else {echo "ASC";}?>">Chain</a> / <a href="locations_state.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.Name&d=<? if ($sortBy=="tblBusinessCustomer.Name") {echo $sd;} else {echo "ASC";}?>">Store
    Location</a></font></strong></td>
    <td width="" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_state.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.Address&d=<? if ($sortBy=="tblBusinessCustomer.Address") {echo $sd;} else {echo "ASC";}?>">Address</a></font></strong></td>
    <td width="" bgcolor="#FFFFCC"><div align="left"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_state.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.City&d=<? if ($sortBy=="tblBusinessCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a></font></strong></div></td>
    <td width="" bgcolor="#FFFFCC"><div align="left"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_state.php?state=<? echo $State; ?>&sort=tblBusinessCustomer.Phone1&d=<? if ($sortBy=="tblBusinessCustomer.Phone1") {echo $sd;} else {echo "ASC";}?>">Phone
