...
// -------------------------- YOUR CODE GOES BELOW THIS LINE ------------------------------------------------------------------- >>>>>
	...
	if($Country == "y")
	{
		$sql = "SELECT * FROM tblBusinessCustomer WHERE CustomerType = 'Bookstore' AND Status = 'active' AND Country <> 'US' AND Country <> 'CA'";
	}
	else
	{

		$sql = "SELECT * FROM tblBusinessCustomer WHERE CustomerType = 'Bookstore' AND Status = 'active' AND Country = '$Country'";
	}
...
<table width="100%" border="1" cellpadding="8" cellspacing="0" bordercolor="#CCCCCC">
  <tr bgcolor="#003399"> 
    <td width="" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_country.php?country=<? echo $Country; ?>&sort=tblBusinessCustomer.Chain&d=<? if ($sortBy=="tblBusinessCustomer.Chain") {echo $sd;} else {echo "ASC";}?>">Chain</a> / <a href="locations_country.php?country=<? echo $Country; ?>&sort=tblBusinessCustomer.Name&d=<? if ($sortBy=="tblBusinessCustomer.Name") {echo $sd;} else {echo "ASC";}?>">Store
    Location</a></font></strong></td>
    <td width="" bgcolor="#FFFFCC"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_country.php?country=<? echo $Country; ?>&sort=tblBusinessCustomer.Address&d=<? if ($sortBy=="tblBusinessCustomer.Address") {echo $sd;} else {echo "ASC";}?>">Address</a></font></strong></td>
    <td width="" bgcolor="#FFFFCC"><div align="left"><strong><font color="#003399"><font size="2" face="Arial, Helvetica, sans-serif"><a href="locations_country.php?country=<? echo $Country; ?>&sort=tblBusinessCustomer.City&d=<? if ($sortBy=="tblBusinessCustomer.City") {echo $sd;} else {echo "ASC";}?>">City</a>, </font><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_country.php?country=<? echo $Country; ?>&sort=tblBusinessCustomer.State&d=<? if ($sortBy=="tblBusinessCustomer.State") {echo $sd;} else {echo "ASC";}?>">State</a></font></font></strong></div></td>
    <td width="" bgcolor="#FFFFCC"><div align="left"><strong><font color="#003399" size="2" face="Arial, Helvetica, sans-serif"><a href="locations_country.php?country=<? echo $Country; ?>&sort=tblBusinessCustomer.Phone1&d=<? if ($sortBy=="tblBusinessCustomer.Phone1") {echo $sd;} else {echo "ASC";}?>">Phone
...
<br>
 <br>			
<p align="left"><font color="#003399" size="5" face="Arial, Helvetica, sans-serif">There are currently no locations outside of the US and Canada.</font><font size="5" face="Arial, Helvetica, sans-serif"><br>
