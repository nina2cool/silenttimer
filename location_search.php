...
?> 
  ...
  <u>The Silent Timer&#8482;</u> at a bookstore near you!</font></strong> </p>
  <table width="100%"  border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td><font size="2" face="Arial, Helvetica, sans-serif">The Silent Timer&#8482; is
          available at over 500 stores nationwide and in Canada. <a href="#Map">Click on your
  ...
  <p><font size="2" face="Arial, Helvetica, sans-serif">Remember to <strong><em>call
          the location</em></strong> before going over there to make sure they
          have it in stock; they run low especially when it is close to your
  test date.</font></p>
  <table width="100%"  border="0" cellspacing="0" cellpadding="5">
      <tr valign="top">
        <td><hr noshade>          
        ...
        <form name="form3" method="post" action="storelocator-search.php" onSubmit=" return lockButton(document.form3.Search.value);">
          <table width="80%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC">
            <tr>
              <td width="8%"><font size="2" face="Arial, Helvetica, sans-serif"> <a name="ZipCode"></a>
        ...
        <td width="50%"><table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
          <tr>
            <td><p><font color="#FF0000"><strong><font size="3" face="Arial, Helvetica, sans-serif"><u>Good
                        news! </u></font></strong></font><font size="2" face="Arial, Helvetica, sans-serif"><br>
        Any <strong>Barnes &amp; Noble, Inc. store</strong> in the U.S. can special order The
        Silent Timer&#8482; for you. They do not carry it in stock regularly
        yet, but special orders are available.</font></p>
                <p align="left"><font size="1" face="Arial, Helvetica, sans-serif"><strong>The Silent Timer&#8482; LSAT</strong>:
                    ISBN 
                    0-9753503-0-7.</font><font size="1"><br>
                        <font face="Arial, Helvetica, sans-serif"><strong>The
                        Silent Timer&#8482; SAT/ACT: ISBN </strong>
                        0-9753503-1-5.</font></font></p>
                <p align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="http://storelocator.barnesandnoble.com/find_a_store.do" target="_blank">Find
                      a B&amp;N location near you!</a></font></p></td>
          </tr>
        </table></td>
      </tr>
    </table>
