...
<? /*
	...
	$sql3 = "SELECT * FROM tblCategory WHERE Status = 'active' AND Type = 'Product' ORDER BY Priority";
	...
	$sql = "SELECT * FROM tblProductNew WHERE OnHand > '0' AND CategoryID = '$CategoryID' AND Status = 'active' ORDER BY Priority";
...
<p align="left"><font color="#003399" size="4" face="Arial, Helvetica, sans-serif"><strong><a name="<? echo $CategoryID; ?>"></a><? echo $Category; ?></strong></font></p>
...
?>
        ...
        <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#003399">
          <tr>
            <td<? if($array[$j][5] > 1) { ?> bgcolor="#FFFFCC"<? } ?>><table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#6C999F">
              ...
              <tr>
                <td colspan="2"><div align="center"><font size="2"><a href="product_detail.php?p=<? echo $array[$j][0];?>"><img src="<? echo $image_path . $array[$j][1];?>" alt="<? echo $array[$j][3]; ?>" width="150" height="100" border="0"></a></font><br>
                </a></font></div></td>
              </tr>
              <tr>
                <td><strong><font size="3" face="Arial, Helvetica, sans-serif">$ <? echo number_format($array[$j][4],2);?></font></strong></td>
        ...
        <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#003399">
          <tr>
            <td<? if($array[$j+1][5] > 1) { ?> bgcolor="#FFFFCC"<? } ?>><table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#6C999F">
              ...
              <tr>
                <td colspan="2"><div align="center"><font size="2"><a href="product_detail.php?p=<? echo $array[$j+1][0];?>"><img src="<? echo $image_path . $array[$j+1][1];?>" alt="<? echo $array[$j+1][3]; ?>" width="150" height="100" border="0"></a></font><br>
                </a></font></div></td>
              </tr>
              <tr>
                <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>$ <? echo number_format($array[$j+1][4],2);?></strong></font><font size="3">&nbsp;</font></td>
        ...
        <table width="100%"  border="1" cellpadding="5" cellspacing="0" bordercolor="#003399">
          <tr>
            <td<? if($array[$j+2][5] > 1) { ?> bgcolor="#FFFFCC"<? } ?>><table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#6C999F">
              ...
              <tr>
                <td colspan="2"><div align="center"><font size="2"><a href="product_detail.php?p=<? echo $array[$j+2][0];?>"><img src="<? echo $image_path . $array[$j+2][1];?>" alt="<? echo $array[$j+2][3]; ?>" width="150" height="100" border="0"></a></font><br>
                </a></font></div></td>
              </tr>
              <tr>
                <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>$ <? echo number_format($array[$j+2][4],2);?></strong></font><font size="3">&nbsp;</font></td>
  ...
  <?
		# move item numbers forward 3 products!
		$j=$j+3;	
	}
