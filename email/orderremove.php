<?
	...
	$sql = "SELECT * from tblPreOrder WHERE email = '$email' GROUP BY email";
...
<HTML>
<HEAD>
<TITLE>The Silent Timer - Pre-Order Management</TITLE>
...
<TABLE WIDTH=822 BORDER=0 CELLPADDING=0 CELLSPACING=0>
    ...
    <TD width="661" ROWSPAN=2 align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="7">
        <tr>
          <td width="1%">&nbsp;</td>
          <td width="99%" align="left" valign="top"> <p><strong><font size="5" face="Arial, Helvetica, sans-serif">Pre-Order 
              List Management</font></strong></p>
            <p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><? echo $name?></strong></font></p>
            <p align="left"><font size="2" face="Arial, Helvetica, sans-serif">If 
              you would like to remove your name from our Silent Timer pre-order 
              list, please press <strong>remove me</strong> below. Before you 
              go, I hope you will take a few seconds to find out how The Silent 
              Timer can help you increase your test scores.</font></p>
            <p align="left">&nbsp;</p>
            <p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><a href="removeo.php?e=<? echo $email?>&n=<? echo $name?>"><strong>Remove 
              Me</strong></a>&nbsp; | &nbsp;<a href="../index.php"><strong>Show 
              me how to increase my test scores</strong></a></font></p>
            <p align="left">&nbsp;</p>
            <p align="left">&nbsp;</p>
            <p align="left">&nbsp;</p>
            <p align="left">&nbsp;</p>
