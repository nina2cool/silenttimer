	...
	if($_POST['Submit'] == "Send Emails") # if button has been pressed...
	{
		...
		if($Email != "")
		{
			require "../code/class.phpmailer.php";
				...
				$sql = "INSERT INTO tblFriend(Name, Email, DateTime, Link, Type, Status, Note)
				VALUES('$Name', '$Email', '$Now', 'email.php', 'sender', 'active', '$Note');";	
...
The Silent Timer is the perfect choice to help you practice your timing for your upcoming $Test.  It is completely silent and has some cool features made for your test.
...
Here are a few:
   ...
   - It has easy to use memory buttons so you can easily program it for your $Test.
...
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Enter in
    ...
    about  the new <font color="#000066" face="Times New Roman, Times, serif"><strong>SILENT
     ...
     like  the <a href="../testhome/sat_test.php">SAT</a>, <a href="../testhome/act_test.php">ACT</a>, 
  <a href="../testhome/lsat_test.php">LSAT</a>, or <a href="../testhome/mcat_test.php">MCAT</a>,
...
<p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Taking
  ...
  <a href="../handbook/standardizedtest/index.php" target="_blank">standardized
   ...
   that  we are here to help with their <a href="../handbook/timemanagement/index.php" target="_blank">time
    management</a>.</font></p>
