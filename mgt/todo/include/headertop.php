<?
	...
	*//////////////////////////////////////////////////////////////
	...
	# if affiliate ID is empty... try to get it from URL
	if($aID == "")
	{
...
<HTML>
<HEAD>
<TITLE><? if($PageTitle != ""){echo $PageTitle;}else{echo "The Silent Timer - practice your way to higher test scores";}?></TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
<meta name="Keywords" content="LSAT, MCAT, SAT, ACT, GMAT, GRE, TOEFL, Test, LSAT Test, MCAT Test, SAT Test, ACT Test, GMAT Test, GRE Test, TOEFL Test, The Silent Timer, timer, CountDown, count down, silent, silent timer, quiet, quiet timer, test timer, standardized test, test prep, preparation, time, time management, score high, silent watch, MCAT watch, LSAT watch, SAT watch, ACT watch, watch, testing watch">
