...
# ---------------------------------------------------------------------------
	...
	$handle = fopen ("shippingexport/reg2.csv","r");
	...
	while ($data = fgetcsv ($handle, 1000, ","))
	{
		...
		$sql = "INSERT INTO tblRegistration(FirstName, TestID, Email) 
	 			VALUES ('$FirstName', '1', '$Email')";
		 
		mysql_query($sql) or die("Cannot insert names, please try again.");
